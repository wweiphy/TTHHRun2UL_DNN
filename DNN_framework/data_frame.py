...
#                df = df.astype('float64') # added by Wei
        ...
        if Do_Evaluation:
            ...
            #         (x['Triggered_HLT_Ele32_WPTight_Gsf_L1DoubleEG_vX'] == 1) & (x['Triggered_HLT_Ele32_WPTight_Gsf_2017SeedsX'] == 1))) & (x['Weight_ElectronTriggerSF'] > 0)) * 1. * x['Weight_ElectronTriggerSF'] + (((x['N_LooseElectrons'] == 0) & (x['N_TightMuons'] == 1) & (x['Triggered_HLT_IsoMu27_vX'])) & (x['Weight_MuonTriggerSF'] > 0.)) * 1. * x['Weight_MuonTriggerSF'])))
                ...
                internal = pd.read_csv("./GenNormMap/internalNorm.xlsx")
                internal_ttbb = pd.read_csv(
                    "./GenNormMap/internalNorm_ttbb.xlsx")
                ttbb = pd.read_csv("./GenNormMap/fracttbb.xlsx")
                ttbb_ttbb = pd.read_csv("./GenNormMap/fracttbb_ttbb.xlsx")
                ttcc = pd.read_csv("./GenNormMap/fracttcc.xlsx")
                ttcc_ttbb = pd.read_csv("./GenNormMap/fracttcc_ttbb.xlsx")
                ttlf = pd.read_csv("./GenNormMap/fracttlf.xlsx")
                ttlf_ttbb = pd.read_csv("./GenNormMap/fracttlf_ttbb.xlsx")
