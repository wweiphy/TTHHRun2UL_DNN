...
#                df = df.astype('float64') # added by Wei
        ...
        if Do_Evaluation:
            ...
            # self.neventsbeforeEvenOdd = df.shape[0]
            # df = df[df['Evt_Odd'] == 0]
            # self.nevents = df.shape[0]
            # self.ratio = float(self.nevents)/float(self.neventsbeforeEvenOdd)
            # print("Even and Odd event ratio: ", self.ratio)
            ...
            if "nominal" in self.path: 
                ...
                df = df.assign(total_weight_scaleMuRUp=lambda x: (((x['process'] == "ttSL")*1. * float(self.genfile[(self.genfile['sample'] == "ttSL") & (self.genfile['variation'] == 'Weight_scale_variation_muR_2p0_muF_1p0')]['final_weight_sl_analysis'].values[0]) * x['Weight_scale_variation_muR_2p0_muF_1p0'] + (x['process'] == "ttDL")*1. * float(self.genfile[(self.genfile['sample'] == "ttDL") & (self.genfile['variation'] == 'Weight_scale_variation_muR_2p0_muF_1p0')]['final_weight_sl_analysis'].values[0]) * x['Weight_scale_variation_muR_2p0_muF_1p0'] + (x['process'] == "ttbbSL")*1. * float(self.genfile[(self.genfile['sample'] == "ttbbSL") & (self.genfile['variation'] == 'Weight_scale_variation_muR_2p0_muF_1p0')]['ratio_ttB_varied_vs_nom_5FS'].values[0]) + (x['process'] == "ttbbDL")*1. * float(self.genfile[(self.genfile['sample'] == "ttbbDL") & (self.genfile['variation'] == 'Weight_scale_variation_muR_2p0_muF_1p0')]['ratio_ttB_varied_vs_nom_5FS'].values[0]) + (x['process'] == "tt4b")*1.) * x.total_preweight))
                ...
                df = df.assign(total_weight_scaleMuRDown=lambda x: (((x['process'] == "ttSL")*1. * float(self.genfile[(self.genfile['sample'] == "ttSL") & (self.genfile['variation'] == 'Weight_scale_variation_muR_0p5_muF_1p0')]['final_weight_sl_analysis'].values[0]) * x['Weight_scale_variation_muR_0p5_muF_1p0'] + (x['process'] == "ttDL")*1. * float(self.genfile[(self.genfile['sample'] == "ttDL") & (self.genfile['variation'] == 'Weight_scale_variation_muR_0p5_muF_1p0')]['final_weight_sl_analysis'].values[0]) * x['Weight_scale_variation_muR_0p5_muF_1p0'] + (x['process'] == "ttbbSL")*1. * float(self.genfile[(self.genfile['sample'] == "ttbbSL") & (self.genfile['variation'] == 'Weight_scale_variation_muR_0p5_muF_1p0')]['ratio_ttB_varied_vs_nom_5FS'].values[0]) + (x['process'] == "ttbbDL")*1. * float(self.genfile[(self.genfile['sample'] == "ttbbDL") & (self.genfile['variation'] == 'Weight_scale_variation_muR_0p5_muF_1p0')]['ratio_ttB_varied_vs_nom_5FS'].values[0]) + (x['process'] == "tt4b")*1.) * x.total_preweight))
                ...
                df = df.assign(total_weight_scaleMuFDown=lambda x: (((x['process'] == "ttSL")*1. * float(self.genfile[(self.genfile['sample'] == "ttSL") & (self.genfile['variation'] == 'Weight_scale_variation_muR_1p0_muF_0p5')]['final_weight_sl_analysis'].values[0]) * x['Weight_scale_variation_muR_1p0_muF_0p5'] + (x['process'] == "ttDL")*1. * float(self.genfile[(self.genfile['sample'] == "ttDL") & (self.genfile['variation'] == 'Weight_scale_variation_muR_1p0_muF_0p5')]['final_weight_sl_analysis'].values[0]) * x['Weight_scale_variation_muR_1p0_muF_0p5'] + (x['process'] == "ttbbSL")*1. * float(self.genfile[(self.genfile['sample'] == "ttbbSL") & (self.genfile['variation'] == 'Weight_scale_variation_muR_1p0_muF_0p5')]['ratio_ttB_varied_vs_nom_5FS'].values[0]) + (x['process'] == "ttbbDL")*1. * float(self.genfile[(self.genfile['sample'] == "ttbbDL") & (self.genfile['variation'] == 'Weight_scale_variation_muR_1p0_muF_0p5')]['ratio_ttB_varied_vs_nom_5FS'].values[0]) + (x['process'] == "tt4b")*1.) * x.total_preweight))
                ...
                df = df.assign(total_weight_upisr_ttlf=lambda x: (((((x['process'] == "ttSL") & (self.label == "ttlf"))*1. * float(self.genfile[(self.genfile['sample'] == "ttSL") & (self.genfile['variation'] == 'GenWeight_isr_Def_up')]['final_weight_sl_analysis'].values[0]) + ((x['process'] == "ttDL") & (self.label == "ttlf"))*1. * float(self.genfile[(self.genfile['sample'] == "ttDL") & (self.genfile['variation'] == 'GenWeight_isr_Def_up')]['final_weight_sl_analysis'].values[0])) * x['GenWeight_isr_Def_up'] + (
                    (x['process'] == "ttSL") & (self.label == "ttcc"))*1. * float(self.genfile[(self.genfile['sample'] == "ttSL") & (self.genfile['variation'] == 'GenWeight_isr_Def_up')]['ratio_ttC_varied_vs_nom_5FS'].values[0]) + ((x['process'] == "ttDL") & (self.label == "ttcc"))*1. * float(self.genfile[(self.genfile['sample'] == "ttDL") & (self.genfile['variation'] == 'GenWeight_isr_Def_up')]['ratio_ttC_varied_vs_nom_5FS'].values[0]) + (x['process'] == "ttbbSL")*1. * float(self.genfile[(self.genfile['sample'] == "ttbbSL") & (self.genfile['variation'] == 'GenWeight_isr_Def_up')]['ratio_ttB_varied_vs_nom_5FS'].values[0]) + (x['process'] == "ttbbDL")*1. * float(self.genfile[(self.genfile['sample'] == "ttbbDL") & (self.genfile['variation'] == 'GenWeight_isr_Def_up')]['ratio_ttB_varied_vs_nom_5FS'].values[0]) + (x['process'] == "tt4b")*1.) * x.total_preweight))

                df = df.assign(total_weight_upisr_ttbb=lambda x: ((((x['process'] == "ttSL") & (self.label == "ttlf"))*1. * float(self.genfile[(self.genfile['sample'] == "ttSL") & (self.genfile['variation'] == 'GenWeight_isr_Def_up')]['ratio_ttLF_varied_vs_nom_5FS'].values[0]) + ((x['process'] == "ttDL") & (self.label == "ttlf"))*1. * float(self.genfile[(self.genfile['sample'] == "ttDL") & (self.genfile['variation'] == 'GenWeight_isr_Def_up')]['ratio_ttLF_varied_vs_nom_5FS'].values[0]) + ((x['process'] == "ttSL") & (self.label == "ttcc"))*1. * float(self.genfile[(self.genfile['sample'] == "ttSL") & (self.genfile['variation'] == 'GenWeight_isr_Def_up')]['ratio_ttC_varied_vs_nom_5FS'].values[0]) + ((x['process'] == "ttDL") & (self.label == "ttcc"))*1. * float(self.genfile[(self.genfile['sample'] == "ttDL") & (self.genfile['variation'] == 'GenWeight_isr_Def_up')]['ratio_ttC_varied_vs_nom_5FS'].values[0]) + ((x['process'] == "ttbbSL")*1. * float(self.genfile[(self.genfile['sample'] == "ttbbSL") & (self.genfile['variation'] == 'GenWeight_isr_Def_up')]['final_weight_sl_analysis'].values[0]) * x['GenWeight_isr_Def_up']) + ((x['process'] == "ttbbDL")*1. * float(self.genfile[(self.genfile['sample'] == "ttbbDL") & (self.genfile['variation'] == 'GenWeight_isr_Def_up')]['final_weight_sl_analysis'].values[0]) * x['GenWeight_isr_Def_up']) + (x['process'] == "tt4b")*1.) * x.total_preweight))
                ...
                df = df.assign(total_weight_upisr_ttcc=lambda x: ((((x['process'] == "ttSL") & (self.label == "ttlf"))*1. * float(self.genfile[(self.genfile['sample'] == "ttSL") & (self.genfile['variation'] == 'GenWeight_isr_Def_up')]['ratio_ttLF_varied_vs_nom_5FS'].values[0]) + ((x['process'] == "ttDL") & (self.label == "ttlf"))*1. * float(self.genfile[(self.genfile['sample'] == "ttDL") & (self.genfile['variation'] == 'GenWeight_isr_Def_up')]['ratio_ttLF_varied_vs_nom_5FS'].values[0]) + (((x['process'] == "ttSL") & (self.label == "ttcc"))*1. * float(self.genfile[(self.genfile['sample'] == "ttSL") & (self.genfile['variation'] == 'GenWeight_isr_Def_up')]['final_weight_sl_analysis'].values[0]) * x['GenWeight_isr_Def_up']) + ((
                    (x['process'] == "ttDL") & (self.label == "ttcc"))*1. * float(self.genfile[(self.genfile['sample'] == "ttDL") & (self.genfile['variation'] == 'GenWeight_isr_Def_up')]['final_weight_sl_analysis'].values[0]) * x['GenWeight_isr_Def_up']) + (x['process'] == "ttbbSL")*1. * float(self.genfile[(self.genfile['sample'] == "ttbbSL") & (self.genfile['variation'] == 'GenWeight_isr_Def_up')]['ratio_ttB_varied_vs_nom_5FS'].values[0]) + (x['process'] == "ttbbDL")*1. * float(self.genfile[(self.genfile['sample'] == "ttbbDL") & (self.genfile['variation'] == 'GenWeight_isr_Def_up')]['ratio_ttB_varied_vs_nom_5FS'].values[0]) + (x['process'] == "tt4b")*1.) * x.total_preweight))
                ...
                df = df.assign(total_weight_downisr_ttlf=lambda x: (((((x['process'] == "ttSL") & (self.label == "ttlf"))*1. * float(self.genfile[(self.genfile['sample'] == "ttSL") & (self.genfile['variation'] == 'GenWeight_isr_Def_down')]['final_weight_sl_analysis'].values[0]) + ((x['process'] == "ttDL") & (self.label == "ttlf"))*1. * float(self.genfile[(self.genfile['sample'] == "ttDL") & (self.genfile['variation'] == 'GenWeight_isr_Def_down')]['final_weight_sl_analysis'].values[0])) * x['GenWeight_isr_Def_down'] + (
                    (x['process'] == "ttSL") & (self.label == "ttcc"))*1. * float(self.genfile[(self.genfile['sample'] == "ttSL") & (self.genfile['variation'] == 'GenWeight_isr_Def_down')]['ratio_ttC_varied_vs_nom_5FS'].values[0]) + ((x['process'] == "ttDL") & (self.label == "ttcc"))*1. * float(self.genfile[(self.genfile['sample'] == "ttDL") & (self.genfile['variation'] == 'GenWeight_isr_Def_down')]['ratio_ttC_varied_vs_nom_5FS'].values[0]) + (x['process'] == "ttbbSL")*1. * float(self.genfile[(self.genfile['sample'] == "ttbbSL") & (self.genfile['variation'] == 'GenWeight_isr_Def_down')]['ratio_ttB_varied_vs_nom_5FS'].values[0]) + (x['process'] == "ttbbDL")*1. * float(self.genfile[(self.genfile['sample'] == "ttbbDL") & (self.genfile['variation'] == 'GenWeight_isr_Def_down')]['ratio_ttB_varied_vs_nom_5FS'].values[0]) + (x['process'] == "tt4b")*1.) * x.total_preweight))
                ...
                df = df.assign(total_weight_upfsr_ttlf=lambda x: (((((x['process'] == "ttSL") & (self.label == "ttlf"))*1. * float(self.genfile[(self.genfile['sample'] == "ttSL") & (self.genfile['variation'] == 'GenWeight_fsr_Def_up')]['final_weight_sl_analysis'].values[0]) + ((x['process'] == "ttDL") & (self.label == "ttlf"))*1. * float(self.genfile[(self.genfile['sample'] == "ttDL") & (self.genfile['variation'] == 'GenWeight_fsr_Def_up')]['final_weight_sl_analysis'].values[0])) * x['GenWeight_fsr_Def_up'] + (
                    (x['process'] == "ttSL") & (self.label == "ttcc"))*1. * float(self.genfile[(self.genfile['sample'] == "ttSL") & (self.genfile['variation'] == 'GenWeight_fsr_Def_up')]['ratio_ttC_varied_vs_nom_5FS'].values[0]) + ((x['process'] == "ttDL") & (self.label == "ttcc"))*1. * float(self.genfile[(self.genfile['sample'] == "ttDL") & (self.genfile['variation'] == 'GenWeight_fsr_Def_up')]['ratio_ttC_varied_vs_nom_5FS'].values[0]) + (x['process'] == "ttbbSL")*1. * float(self.genfile[(self.genfile['sample'] == "ttbbSL") & (self.genfile['variation'] == 'GenWeight_fsr_Def_up')]['ratio_ttB_varied_vs_nom_5FS'].values[0]) + (x['process'] == "ttbbDL")*1. * float(self.genfile[(self.genfile['sample'] == "ttbbDL") & (self.genfile['variation'] == 'GenWeight_fsr_Def_up')]['ratio_ttB_varied_vs_nom_5FS'].values[0]) + (x['process'] == "tt4b")*1.) * x.total_preweight))
                ...
                df = df.assign(total_weight_upfsr_ttcc=lambda x: ((((x['process'] == "ttSL") & (self.label == "ttlf"))*1. * float(self.genfile[(self.genfile['sample'] == "ttSL") & (self.genfile['variation'] == 'GenWeight_fsr_Def_up')]['ratio_ttLF_varied_vs_nom_5FS'].values[0]) + ((x['process'] == "ttDL") & (self.label == "ttlf"))*1. * float(self.genfile[(self.genfile['sample'] == "ttDL") & (self.genfile['variation'] == 'GenWeight_fsr_Def_up')]['ratio_ttLF_varied_vs_nom_5FS'].values[0]) + (((x['process'] == "ttSL") & (self.label == "ttcc"))*1. * float(self.genfile[(self.genfile['sample'] == "ttSL") & (self.genfile['variation'] == 'GenWeight_fsr_Def_up')]['final_weight_sl_analysis'].values[0]) * x['GenWeight_fsr_Def_up'])  + ((
                    (x['process'] == "ttDL") & (self.label == "ttcc"))*1. * float(self.genfile[(self.genfile['sample'] == "ttDL") & (self.genfile['variation'] == 'GenWeight_fsr_Def_up')]['final_weight_sl_analysis'].values[0]) * x['GenWeight_fsr_Def_up']) + (x['process'] == "ttbbSL")*1. * float(self.genfile[(self.genfile['sample'] == "ttbbSL") & (self.genfile['variation'] == 'GenWeight_fsr_Def_up')]['ratio_ttB_varied_vs_nom_5FS'].values[0]) + (x['process'] == "ttbbDL")*1. * float(self.genfile[(self.genfile['sample'] == "ttbbDL") & (self.genfile['variation'] == 'GenWeight_fsr_Def_up')]['ratio_ttB_varied_vs_nom_5FS'].values[0]) + (x['process'] == "tt4b")*1.) * x.total_preweight))
                ...
                df = df.assign(total_weight_downfsr_ttlf=lambda x: (((((x['process'] == "ttSL") & (self.label == "ttlf"))*1. * float(self.genfile[(self.genfile['sample'] == "ttSL") & (self.genfile['variation'] == 'GenWeight_fsr_Def_down')]['final_weight_sl_analysis'].values[0]) + ((x['process'] == "ttDL") & (self.label == "ttlf"))*1. * float(self.genfile[(self.genfile['sample'] == "ttDL") & (self.genfile['variation'] == 'GenWeight_fsr_Def_down')]['final_weight_sl_analysis'].values[0])) * x['GenWeight_fsr_Def_down'] + (
                    (x['process'] == "ttSL") & (self.label == "ttcc"))*1. * float(self.genfile[(self.genfile['sample'] == "ttSL") & (self.genfile['variation'] == 'GenWeight_fsr_Def_down')]['ratio_ttC_varied_vs_nom_5FS'].values[0]) + ((x['process'] == "ttDL") & (self.label == "ttcc"))*1. * float(self.genfile[(self.genfile['sample'] == "ttDL") & (self.genfile['variation'] == 'GenWeight_fsr_Def_down')]['ratio_ttC_varied_vs_nom_5FS'].values[0]) + (x['process'] == "ttbbSL")*1. * float(self.genfile[(self.genfile['sample'] == "ttbbSL") & (self.genfile['variation'] == 'GenWeight_fsr_Def_down')]['ratio_ttB_varied_vs_nom_5FS'].values[0]) + (x['process'] == "ttbbDL")*1. * float(self.genfile[(self.genfile['sample'] == "ttbbDL") & (self.genfile['variation'] == 'GenWeight_fsr_Def_down')]['ratio_ttB_varied_vs_nom_5FS'].values[0]) + (x['process'] == "tt4b")*1.) * x.total_preweight))
                ...
                df = df.assign(total_weight_downfsr_ttbb=lambda x: ((((x['process'] == "ttSL") & (self.label == "ttlf"))*1. * float(self.genfile[(self.genfile['sample'] == "ttSL") & (self.genfile['variation'] == 'GenWeight_fsr_Def_down')]['ratio_ttLF_varied_vs_nom_5FS'].values[0]) + ((x['process'] == "ttDL") & (self.label == "ttlf"))*1. * float(self.genfile[(self.genfile['sample'] == "ttDL") & (self.genfile['variation'] == 'GenWeight_fsr_Def_down')]['ratio_ttLF_varied_vs_nom_5FS'].values[0]) + ((x['process'] == "ttSL") & (self.label == "ttcc"))*1. * float(self.genfile[(self.genfile['sample'] == "ttSL") & (self.genfile['variation'] == 'GenWeight_fsr_Def_down')]['ratio_ttC_varied_vs_nom_5FS'].values[0]) + (
                    (x['process'] == "ttDL") & (self.label == "ttcc"))*1. * float(self.genfile[(self.genfile['sample'] == "ttDL") & (self.genfile['variation'] == 'GenWeight_fsr_Def_down')]['ratio_ttC_varied_vs_nom_5FS'].values[0]) + ((x['process'] == "ttbbSL")*1. * float(self.genfile[(self.genfile['sample'] == "ttbbSL") & (self.genfile['variation'] == 'GenWeight_fsr_Def_down')]['final_weight_sl_analysis'].values[0]) * x['GenWeight_fsr_Def_down']) + ((x['process'] == "ttbbDL")*1. * float(self.genfile[(self.genfile['sample'] == "ttbbDL") & (self.genfile['variation'] == 'GenWeight_fsr_Def_down')]['final_weight_sl_analysis'].values[0]) * x['GenWeight_fsr_Def_down']) + (x['process'] == "tt4b")*1.) * x.total_preweight))
                ...
                df = df.assign(total_weight_downfsr_ttcc=lambda x: ((((x['process'] == "ttSL") & (self.label == "ttlf"))*1. * float(self.genfile[(self.genfile['sample'] == "ttSL") & (self.genfile['variation'] == 'GenWeight_fsr_Def_down')]['ratio_ttLF_varied_vs_nom_5FS'].values[0]) + ((x['process'] == "ttDL") & (self.label == "ttlf"))*1. * float(self.genfile[(self.genfile['sample'] == "ttDL") & (self.genfile['variation'] == 'GenWeight_fsr_Def_down')]['ratio_ttLF_varied_vs_nom_5FS'].values[0]) + (((x['process'] == "ttSL") & (self.label == "ttcc"))*1. * float(self.genfile[(self.genfile['sample'] == "ttSL") & (self.genfile['variation'] == 'GenWeight_fsr_Def_down')]['final_weight_sl_analysis'].values[0])  * x['GenWeight_fsr_Def_down']) + ((
                    (x['process'] == "ttDL") & (self.label == "ttcc"))*1. * float(self.genfile[(self.genfile['sample'] == "ttDL") & (self.genfile['variation'] == 'GenWeight_fsr_Def_down')]['final_weight_sl_analysis'].values[0]) * x['GenWeight_fsr_Def_down']) + (x['process'] == "ttbbSL")*1. * float(self.genfile[(self.genfile['sample'] == "ttbbSL") & (self.genfile['variation'] == 'GenWeight_fsr_Def_down')]['ratio_ttB_varied_vs_nom_5FS'].values[0]) + (x['process'] == "ttbbDL")*1. * float(self.genfile[(self.genfile['sample'] == "ttbbDL") & (self.genfile['variation'] == 'GenWeight_fsr_Def_down')]['ratio_ttB_varied_vs_nom_5FS'].values[0]) + (x['process'] == "tt4b")*1.) * x.total_preweight))
            ...
            # if not (self.label == "SingleMuon" or self.label == "SingleElectron"):
                ...
                # df = df.assign(
                    # total_weight=lambda x: self.normalization_weight * x.total_weight)
