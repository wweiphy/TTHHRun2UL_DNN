        ...
        if Do_Evaluation:
            ...
            if ("ttlf" or "ttcc") in self.path:
                df = df.assign(total_weight=lambda x: ((abs(x['Weight_scale_variation_muR_0p5_muF_0p5']) <= 100) & (abs(x['Weight_scale_variation_muR_0p5_muF_1p0']) <= 100) & (abs(x['Weight_scale_variation_muR_0p5_muF_2p0']) <= 100) & (abs(x['Weight_scale_variation_muR_1p0_muF_0p5']) <= 100) & (abs(
                    x['Weight_scale_variation_muR_1p0_muF_1p0']) <= 100) & (abs(x['Weight_scale_variation_muR_1p0_muF_2p0']) <= 100) & (abs(x['Weight_scale_variation_muR_2p0_muF_0p5']) <= 100) & (abs(x['Weight_scale_variation_muR_2p0_muF_1p0']) <= 100) & (abs(x['Weight_scale_variation_muR_2p0_muF_2p0']) <= 100)))
            else:
