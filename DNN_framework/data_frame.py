...
#                df = df.astype('float64') # added by Wei
        ...
        if Do_Evaluation:
            ...
            #         (x['Triggered_HLT_Ele32_WPTight_Gsf_L1DoubleEG_vX'] == 1) & (x['Triggered_HLT_Ele32_WPTight_Gsf_2017SeedsX'] == 1))) & (x['Weight_ElectronTriggerSF'] > 0)) * 1. * x['Weight_ElectronTriggerSF'] + (((x['N_LooseElectrons'] == 0) & (x['N_TightMuons'] == 1) & (x['Triggered_HLT_IsoMu27_vX'])) & (x['Weight_MuonTriggerSF'] > 0.)) * 1. * x['Weight_MuonTriggerSF'])))
                ...
                internal = pd.read_excel("./GenNormMap/internalNorm.xlsx")
                internal_ttbb = pd.read_excel(
                    "./GenNormMap/internalNorm_ttbb.xlsx")
                ttbb = pd.read_excel("./GenNormMap/fracttbb.xlsx")
                ttbb_ttbb = pd.read_excel("./GenNormMap/fracttbb_ttbb.xlsx")
                ttcc = pd.read_excel("./GenNormMap/fracttcc.xlsx")
                ttcc_ttbb = pd.read_excel("./GenNormMap/fracttcc_ttbb.xlsx")
                ttlf = pd.read_excel("./GenNormMap/fracttlf.xlsx")
                ttlf_ttbb = pd.read_excel("./GenNormMap/fracttlf_ttbb.xlsx")
                ...
                for x in range(306000, 306103):
                    ...
                    df['total_weight_PDF_Weight_{}'.format(x)] = df['Weight_pdf_variation_{}'.format(
                        x)]*((df['process'] == "ttSL")*1. * internal['ttSL'][internal[internal['Name'] == 'Weight_pdf_variation_{}'.format(x)].index] + (df['process'] == "ttDL")*1. * internal['ttDL'][internal[internal['Name'] == 'Weight_pdf_variation_{}'.format(x)].index] + (df['process'] == "ttH")*1. * internal['ttH'][internal[internal['Name'] == 'Weight_pdf_variation_{}'.format(x)].index]) * df['total_preweight']*df['compare']*1.
                ...
                df = df.assign(total_weight_scaleMuR_ttbbNLOUp=lambda x: (((x['process'] == "ttbbSL")*1. * internal_ttbb['ttbbSL'][internal_ttbb[internal_ttbb['Name'] == 'Weight_scale_variation_muR_2p0_muF_1p0'].index] * x['Weight_scale_variation_muR_2p0_muF_1p0'] + (x['process'] == "ttbbDL")*1. * internal_ttbb['ttbbDL'][internal_ttbb[internal_ttbb['Name'] == 'Weight_scale_variation_muR_2p0_muF_1p0'].index] * x['Weight_scale_variation_muR_2p0_muF_1p0'] + ((self.label == "ttlf") & (
                x['process'] == "ttSL"))*1. * ttlf['ttSL'][ttlf[ttlf['Name'] == 'Weight_scale_variation_muR_2p0_muF_1p0'].index] + ((self.label == "ttlf") & (x['process'] == "ttDL"))*1. * ttlf['ttDL'][ttlf[ttlf['Name'] == 'Weight_scale_variation_muR_2p0_muF_1p0'].index] + ((self.label == "ttcc") & (x['process'] == "ttSL"))*1. * ttcc['ttSL'][ttcc[ttcc['Name'] == 'Weight_scale_variation_muR_2p0_muF_1p0'].index] + ((self.label == "ttcc") & (x['process'] == "ttDL"))*1. * ttcc['ttDL'][ttcc[ttcc['Name'] == 'Weight_scale_variation_muR_2p0_muF_1p0'].index]) * x.total_preweight))

                df = df.assign(total_weight_scaleMuR_ttHUp=lambda x: (
                    (internal['ttH'][internal[internal['Name'] == 'Weight_scale_variation_muR_2p0_muF_1p0'].index] * x['Weight_scale_variation_muR_2p0_muF_1p0']) * x.total_preweight))

                df = df.assign(total_weight_scaleMuRDown=lambda x: (((x['process'] == "ttSL")*1. * internal['ttSL'][internal[internal['Name'] == 'Weight_scale_variation_muR_0p5_muF_1p0'].index] * x['Weight_scale_variation_muR_0p5_muF_1p0'] + (x['process'] == "ttDL")*1. * internal['ttDL'][internal[internal['Name'] == 'Weight_scale_variation_muR_0p5_muF_1p0'].index] * x['Weight_scale_variation_muR_0p5_muF_1p0'] + (x['process'] == "ttbbSL")*1. * internal_ttbb['ttbbSL'][internal_ttbb[internal_ttbb['Name'] == 'Weight_scale_variation_muR_0p5_muF_1p0'].index] + (x['process'] == "ttbbDL")*1. * internal_ttbb['ttbbSL'][internal_ttbb[internal_ttbb['Name'] == 'Weight_scale_variation_muR_0p5_muF_1p0'].index]) * x.total_preweight))

                df = df.assign(total_weight_scaleMuR_ttbbNLODown=lambda x: (((x['process'] == "ttbbSL")*1. * internal_ttbb['ttbbSL'][internal_ttbb[internal_ttbb['Name'] == 'Weight_scale_variation_muR_0p5_muF_1p0'].index] * x['Weight_scale_variation_muR_0p5_muF_1p0'] + (x['process'] == "ttbbDL")*1. * internal_ttbb['ttbbDL'][internal_ttbb[internal_ttbb['Name'] == 'Weight_scale_variation_muR_0p5_muF_1p0'].index] * x['Weight_scale_variation_muR_0p5_muF_1p0'] + ((self.label == "ttlf") & (
                    x['process'] == "ttSL"))*1. * ttlf['ttSL'][ttlf[ttlf['Name'] == 'Weight_scale_variation_muR_0p5_muF_1p0'].index] + ((self.label == "ttlf") & (x['process'] == "ttDL"))*1. * ttlf['ttDL'][ttlf[ttlf['Name'] == 'Weight_scale_variation_muR_0p5_muF_1p0'].index] + ((self.label == "ttcc") & (x['process'] == "ttSL"))*1. * ttcc['ttSL'][ttcc[ttcc['Name'] == 'Weight_scale_variation_muR_0p5_muF_1p0'].index] + ((self.label == "ttcc") & (x['process'] == "ttDL"))*1. * ttcc['ttDL'][ttcc[ttcc['Name'] == 'Weight_scale_variation_muR_0p5_muF_1p0'].index]) * x.total_preweight))

                df = df.assign(total_weight_scaleMuR_ttHDown=lambda x: (
                    (internal['ttH'][internal[internal['Name'] == 'Weight_scale_variation_muR_0p5_muF_1p0'].index] * x['Weight_scale_variation_muR_0p5_muF_1p0']) * x.total_preweight))

                df = df.assign(total_weight_scaleMuFUp=lambda x: (((x['process'] == "ttSL")*1. * internal['ttSL'][internal[internal['Name'] == 'Weight_scale_variation_muR_1p0_muF_2p0'].index] * x['Weight_scale_variation_muR_1p0_muF_2p0'] + (x['process'] == "ttDL")*1. * internal['ttDL'][internal[internal['Name'] == 'Weight_scale_variation_muR_1p0_muF_2p0'].index] * x['Weight_scale_variation_muR_1p0_muF_2p0'] + (x['process'] == "ttbbSL")*1. * internal_ttbb['ttbbSL'][internal_ttbb[internal_ttbb['Name'] == 'Weight_scale_variation_muR_1p0_muF_2p0'].index] + (x['process'] == "ttbbDL")*1. * internal_ttbb['ttbbSL'][internal_ttbb[internal_ttbb['Name'] == 'Weight_scale_variation_muR_1p0_muF_2p0'].index]) * x.total_preweight))

                df = df.assign(total_weight_scaleMuF_ttbbNLOUp=lambda x: (((x['process'] == "ttbbSL")*1. * internal_ttbb['ttbbSL'][internal_ttbb[internal_ttbb['Name'] == 'Weight_scale_variation_muR_1p0_muF_2p0'].index] * x['Weight_scale_variation_muR_1p0_muF_2p0'] + (x['process'] == "ttbbDL")*1. * internal_ttbb['ttbbDL'][internal_ttbb[internal_ttbb['Name'] == 'Weight_scale_variation_muR_1p0_muF_2p0'].index] * x['Weight_scale_variation_muR_1p0_muF_2p0'] + ((self.label == "ttlf") & (
                    x['process'] == "ttSL"))*1. * ttlf['ttSL'][ttlf[ttlf['Name'] == 'Weight_scale_variation_muR_1p0_muF_2p0'].index] + ((self.label == "ttlf") & (x['process'] == "ttDL"))*1. * ttlf['ttDL'][ttlf[ttlf['Name'] == 'Weight_scale_variation_muR_1p0_muF_2p0'].index] + ((self.label == "ttcc") & (x['process'] == "ttSL"))*1. * ttcc['ttSL'][ttcc[ttcc['Name'] == 'Weight_scale_variation_muR_1p0_muF_2p0'].index] + ((self.label == "ttcc") & (x['process'] == "ttDL"))*1. * ttcc['ttDL'][ttcc[ttcc['Name'] == 'Weight_scale_variation_muR_1p0_muF_2p0'].index]) * x.total_preweight))

                df = df.assign(total_weight_scaleMuF_ttHUp=lambda x: (
                    (internal['ttH'][internal[internal['Name'] == 'Weight_scale_variation_muR_1p0_muF_2p0'].index] * x['Weight_scale_variation_muR_1p0_muF_2p0']) * x.total_preweight))

                df = df.assign(total_weight_scaleMuFDown=lambda x: (((x['process'] == "ttSL")*1. * internal['ttSL'][internal[internal['Name'] == 'Weight_scale_variation_muR_1p0_muF_0p5'].index] * x['Weight_scale_variation_muR_1p0_muF_0p5'] + (x['process'] == "ttDL")*1. * internal['ttDL']
                    [internal[internal['Name'] == 'Weight_scale_variation_muR_1p0_muF_0p5'].index] * x['Weight_scale_variation_muR_1p0_muF_0p5'] + (x['process'] == "ttbbSL")*1. * internal_ttbb['ttbbSL'][internal_ttbb[internal_ttbb['Name'] == 'Weight_scale_variation_muR_1p0_muF_0p5'].index] + (x['process'] == "ttbbDL")*1. * internal_ttbb['ttbbSL'][internal_ttbb[internal_ttbb['Name'] == 'Weight_scale_variation_muR_1p0_muF_0p5'].index]) * x.total_preweight))

                df = df.assign(total_weight_scaleMuF_ttbbNLODown=lambda x: (((x['process'] == "ttbbSL")*1. * internal_ttbb['ttbbSL'][internal_ttbb[internal_ttbb['Name'] == 'Weight_scale_variation_muR_1p0_muF_0p5'].index] * x['Weight_scale_variation_muR_1p0_muF_0p5'] + (x['process'] == "ttbbDL")*1. * internal_ttbb['ttbbDL'][internal_ttbb[internal_ttbb['Name'] == 'Weight_scale_variation_muR_1p0_muF_0p5'].index] * x['Weight_scale_variation_muR_1p0_muF_0p5'] + ((self.label == "ttlf") & (
                    x['process'] == "ttSL"))*1. * ttlf['ttSL'][ttlf[ttlf['Name'] == 'Weight_scale_variation_muR_1p0_muF_0p5'].index] + ((self.label == "ttlf") & (x['process'] == "ttDL"))*1. * ttlf['ttDL'][ttlf[ttlf['Name'] == 'Weight_scale_variation_muR_1p0_muF_0p5'].index] + ((self.label == "ttcc") & (x['process'] == "ttSL"))*1. * ttcc['ttSL'][ttcc[ttcc['Name'] == 'Weight_scale_variation_muR_1p0_muF_0p5'].index] + ((self.label == "ttcc") & (x['process'] == "ttDL"))*1. * ttcc['ttDL'][ttcc[ttcc['Name'] == 'Weight_scale_variation_muR_1p0_muF_0p5'].index]) * x.total_preweight))

                df = df.assign(total_weight_scaleMuF_ttHDown=lambda x: (
                    (internal['ttH'][internal[internal['Name'] == 'Weight_scale_variation_muR_1p0_muF_0p5'].index] * x['Weight_scale_variation_muR_1p0_muF_0p5']) * x.total_preweight))

                df = df.assign(total_weight_upisr_ttH=lambda x: ((x['process'] == "ttH") * 1. * internal['ttH'][internal[internal['Name'] == 'GenWeight_isr_Def_up'].index] * x['GenWeight_isr_Def_up'] * x.total_preweight))

                df = df.assign(total_weight_upisr_ttlf=lambda x: ((((x['process'] == "ttSL") & (self.label == "ttlf"))*1. * internal['ttSL'][internal[internal['Name'] == 'GenWeight_isr_Def_up'].index] + ((x['process'] == "ttDL") & (self.label == "ttlf"))*1. * internal['ttDL'][internal[internal['Name'] == 'GenWeight_isr_Def_up'].index] * x['GenWeight_isr_Def_up'] + (
                    (x['process'] == "ttSL") & (self.label == "ttcc"))*1. * ttcc['ttSL'][ttcc[ttcc['Name'] == 'GenWeight_isr_Def_up'].index] + ((x['process'] == "ttDL") & (self.label == "ttcc"))*1. * ttcc['ttDL'][ttcc[ttcc['Name'] == 'GenWeight_isr_Def_up'].index] + (x['process'] == "ttbbSL")*1. * ttbb_ttbb['ttbbSL'][ttbb_ttbb[ttbb_ttbb['Name'] == 'GenWeight_isr_Def_up'].index] + (x['process'] == "ttbbDL")*1. * ttbb_ttbb['ttbbDL'][ttbb_ttbb[ttbb_ttbb['Name'] == 'GenWeight_isr_Def_up'].index]) * x.total_preweight))

                df = df.assign(total_weight_upisr_ttbb=lambda x: ((((x['process'] == "ttSL") & (self.label == "ttlf"))*1. * ttlf['ttSL'][ttlf[ttlf['Name'] == 'GenWeight_isr_Def_up'].index] + ((x['process'] == "ttDL") & (self.label == "ttlf"))*1. * ttlf['ttDL'][ttlf[ttlf['Name'] == 'GenWeight_isr_Def_up'].index] + ((x['process'] == "ttSL") & (self.label == "ttcc"))*1. * ttcc['ttSL'][ttcc[ttcc['Name'] == 'GenWeight_isr_Def_up'].index] + (
                    (x['process'] == "ttDL") & (self.label == "ttcc"))*1. * ttcc['ttDL'][ttcc[ttcc['Name'] == 'GenWeight_isr_Def_up'].index] + (x['process'] == "ttbbSL")*1. * internal_ttbb['ttbbSL'][internal_ttbb[internal_ttbb['Name'] == 'GenWeight_isr_Def_up'].index] * x['GenWeight_isr_Def_up'] + (x['process'] == "ttbbDL")*1. * internal_ttbb['ttbbDL'][internal_ttbb[internal_ttbb['Name'] == 'GenWeight_isr_Def_up'].index] * x['GenWeight_isr_Def_up']) * x.total_preweight))
                
                df = df.assign(total_weight_upisr_ttcc=lambda x: ((((x['process'] == "ttSL") & (self.label == "ttcc"))*1. * internal['ttSL'][internal[internal['Name'] == 'GenWeight_isr_Def_up'].index] * x['GenWeight_isr_Def_up'] + ((x['process'] == "ttDL") & (self.label == "ttcc"))*1. * internal['ttDL'][internal[internal['Name'] == 'GenWeight_isr_Def_up'].index] * x['GenWeight_isr_Def_up'] + (
                    (x['process'] == "ttSL") & (self.label == "ttlf"))*1. * ttlf['ttSL'][ttlf[ttlf['Name'] == 'GenWeight_isr_Def_up'].index] + ((x['process'] == "ttDL") & (self.label == "ttlf"))*1. * ttlf['ttDL'][ttlf[ttlf['Name'] == 'GenWeight_isr_Def_up'].index] + (x['process'] == "ttbbSL")*1. * internal_ttbb['ttbbSL'][internal_ttbb[internal_ttbb['Name'] == 'GenWeight_isr_Def_up'].index] + (x['process'] == "ttbbDL")*1. * internal_ttbb['ttbbDL'][internal_ttbb[internal_ttbb['Name'] == 'GenWeight_isr_Def_up'].index]) * x.total_preweight))

                df = df.assign(total_weight_downisr_ttH=lambda x: (
                    (x['process'] == "ttH") * 1. * internal['ttH'][internal[internal['Name'] == 'GenWeight_isr_Def_down'].index] * x['GenWeight_isr_Def_down'] * x.total_preweight))

                df = df.assign(total_weight_downisr_ttlf=lambda x: ((((x['process'] == "ttSL") & (self.label == "ttlf"))*1. * internal['ttSL'][internal[internal['Name'] == 'GenWeight_isr_Def_down'].index] + ((x['process'] == "ttDL") & (self.label == "ttlf"))*1. * internal['ttDL'][internal[internal['Name'] == 'GenWeight_isr_Def_down'].index] * x['GenWeight_isr_Def_down'] + (
                    (x['process'] == "ttSL") & (self.label == "ttcc"))*1. * ttcc['ttSL'][ttcc[ttcc['Name'] == 'GenWeight_isr_Def_down'].index] + ((x['process'] == "ttDL") & (self.label == "ttcc"))*1. * ttcc['ttDL'][ttcc[ttcc['Name'] == 'GenWeight_isr_Def_down'].index] + (x['process'] == "ttbbSL")*1. * ttbb_ttbb['ttbbSL'][ttbb_ttbb[ttbb_ttbb['Name'] == 'GenWeight_isr_Def_down'].index] + (x['process'] == "ttbbDL")*1. * ttbb_ttbb['ttbbDL'][ttbb_ttbb[ttbb_ttbb['Name'] == 'GenWeight_isr_Def_down'].index]) * x.total_preweight))

                df = df.assign(total_weight_downisr_ttbb=lambda x: ((((x['process'] == "ttSL") & (self.label == "ttlf"))*1. * ttlf['ttSL'][ttlf[ttlf['Name'] == 'GenWeight_isr_Def_down'].index] + ((x['process'] == "ttDL") & (self.label == "ttlf"))*1. * ttlf['ttDL'][ttlf[ttlf['Name'] == 'GenWeight_isr_Def_down'].index] + ((x['process'] == "ttSL") & (self.label == "ttcc"))*1. * ttcc['ttSL'][ttcc[ttcc['Name'] == 'GenWeight_isr_Def_down'].index] + (
                    (x['process'] == "ttDL") & (self.label == "ttcc"))*1. * ttcc['ttDL'][ttcc[ttcc['Name'] == 'GenWeight_isr_Def_down'].index] + (x['process'] == "ttbbSL")*1. * internal_ttbb['ttbbSL'][internal_ttbb[internal_ttbb['Name'] == 'GenWeight_isr_Def_down'].index] * x['GenWeight_isr_Def_down'] + (x['process'] == "ttbbDL")*1. * internal_ttbb['ttbbDL'][internal_ttbb[internal_ttbb['Name'] == 'GenWeight_isr_Def_down'].index] * x['GenWeight_isr_Def_down']) * x.total_preweight))

                df = df.assign(total_weight_downisr_ttcc=lambda x: ((((x['process'] == "ttSL") & (self.label == "ttcc"))*1. * internal['ttSL'][internal[internal['Name'] == 'GenWeight_isr_Def_down'].index] * x['GenWeight_isr_Def_down'] + ((x['process'] == "ttDL") & (self.label == "ttcc"))*1. * internal['ttDL'][internal[internal['Name'] == 'GenWeight_isr_Def_down'].index] * x['GenWeight_isr_Def_down'] + (
                    (x['process'] == "ttSL") & (self.label == "ttlf"))*1. * ttlf['ttSL'][ttlf[ttlf['Name'] == 'GenWeight_isr_Def_down'].index] + ((x['process'] == "ttDL") & (self.label == "ttlf"))*1. * ttlf['ttDL'][ttlf[ttlf['Name'] == 'GenWeight_isr_Def_down'].index] + (x['process'] == "ttbbSL")*1. * internal_ttbb['ttbbSL'][internal_ttbb[internal_ttbb['Name'] == 'GenWeight_isr_Def_down'].index] + (x['process'] == "ttbbDL")*1. * internal_ttbb['ttbbDL'][internal_ttbb[internal_ttbb['Name'] == 'GenWeight_isr_Def_down'].index]) * x.total_preweight))

                
                
                # fsr

                df = df.assign(total_weight_upfsr_ttH=lambda x: ((x['process'] == "ttH") * 1. * internal['ttH'][internal[internal['Name'] == 'GenWeight_fsr_Def_up'].index] * x['GenWeight_fsr_Def_up'] * x.total_preweight))

                df = df.assign(total_weight_upfsr_ttlf=lambda x: ((((x['process'] == "ttSL") & (self.label == "ttlf"))*1. * internal['ttSL'][internal[internal['Name'] == 'GenWeight_fsr_Def_up'].index] + ((x['process'] == "ttDL") & (self.label == "ttlf"))*1. * internal['ttDL'][internal[internal['Name'] == 'GenWeight_fsr_Def_up'].index] * x['GenWeight_fsr_Def_up'] + (
                    (x['process'] == "ttSL") & (self.label == "ttcc"))*1. * ttcc['ttSL'][ttcc[ttcc['Name'] == 'GenWeight_fsr_Def_up'].index] + ((x['process'] == "ttDL") & (self.label == "ttcc"))*1. * ttcc['ttDL'][ttcc[ttcc['Name'] == 'GenWeight_fsr_Def_up'].index] + (x['process'] == "ttbbSL")*1. * ttbb_ttbb['ttbbSL'][ttbb_ttbb[ttbb_ttbb['Name'] == 'GenWeight_fsr_Def_up'].index] + (x['process'] == "ttbbDL")*1. * ttbb_ttbb['ttbbDL'][ttbb_ttbb[ttbb_ttbb['Name'] == 'GenWeight_fsr_Def_up'].index]) * x.total_preweight))

                df = df.assign(total_weight_upfsr_ttbb=lambda x: ((((x['process'] == "ttSL") & (self.label == "ttlf"))*1. * ttlf['ttSL'][ttlf[ttlf['Name'] == 'GenWeight_fsr_Def_up'].index] + ((x['process'] == "ttDL") & (self.label == "ttlf"))*1. * ttlf['ttDL'][ttlf[ttlf['Name'] == 'GenWeight_fsr_Def_up'].index] + ((x['process'] == "ttSL") & (self.label == "ttcc"))*1. * ttcc['ttSL'][ttcc[ttcc['Name'] == 'GenWeight_fsr_Def_up'].index] + (
                    (x['process'] == "ttDL") & (self.label == "ttcc"))*1. * ttcc['ttDL'][ttcc[ttcc['Name'] == 'GenWeight_fsr_Def_up'].index] + (x['process'] == "ttbbSL")*1. * internal_ttbb['ttbbSL'][internal_ttbb[internal_ttbb['Name'] == 'GenWeight_fsr_Def_up'].index] * x['GenWeight_fsr_Def_up'] + (x['process'] == "ttbbDL")*1. * internal_ttbb['ttbbDL'][internal_ttbb[internal_ttbb['Name'] == 'GenWeight_fsr_Def_up'].index] * x['GenWeight_fsr_Def_up']) * x.total_preweight))
                
                df = df.assign(total_weight_upfsr_ttcc=lambda x: ((((x['process'] == "ttSL") & (self.label == "ttcc"))*1. * internal['ttSL'][internal[internal['Name'] == 'GenWeight_fsr_Def_up'].index] * x['GenWeight_fsr_Def_up'] + ((x['process'] == "ttDL") & (self.label == "ttcc"))*1. * internal['ttDL'][internal[internal['Name'] == 'GenWeight_fsr_Def_up'].index] * x['GenWeight_fsr_Def_up'] + (
                    (x['process'] == "ttSL") & (self.label == "ttlf"))*1. * ttlf['ttSL'][ttlf[ttlf['Name'] == 'GenWeight_fsr_Def_up'].index] + ((x['process'] == "ttDL") & (self.label == "ttlf"))*1. * ttlf['ttDL'][ttlf[ttlf['Name'] == 'GenWeight_fsr_Def_up'].index] + (x['process'] == "ttbbSL")*1. * internal_ttbb['ttbbSL'][internal_ttbb[internal_ttbb['Name'] == 'GenWeight_fsr_Def_up'].index] + (x['process'] == "ttbbDL")*1. * internal_ttbb['ttbbDL'][internal_ttbb[internal_ttbb['Name'] == 'GenWeight_fsr_Def_up'].index]) * x.total_preweight))

                df = df.assign(total_weight_downfsr_ttH=lambda x: ((x['process'] == "ttH") * 1. * internal['ttH'][internal[internal['Name'] == 'GenWeight_fsr_Def_down'].index] * x['GenWeight_fsr_Def_down'] * x.total_preweight))

                df = df.assign(total_weight_downfsr_ttlf=lambda x: ((((x['process'] == "ttSL") & (self.label == "ttlf"))*1. * internal['ttSL'][internal[internal['Name'] == 'GenWeight_fsr_Def_down'].index] + ((x['process'] == "ttDL") & (self.label == "ttlf"))*1. * internal['ttDL'][internal[internal['Name'] == 'GenWeight_fsr_Def_down'].index] * x['GenWeight_fsr_Def_down'] + (
                    (x['process'] == "ttSL") & (self.label == "ttcc"))*1. * ttcc['ttSL'][ttcc[ttcc['Name'] == 'GenWeight_fsr_Def_down'].index] + ((x['process'] == "ttDL") & (self.label == "ttcc"))*1. * ttcc['ttDL'][ttcc[ttcc['Name'] == 'GenWeight_fsr_Def_down'].index] + (x['process'] == "ttbbSL")*1. * ttbb_ttbb['ttbbSL'][ttbb_ttbb[ttbb_ttbb['Name'] == 'GenWeight_fsr_Def_down'].index] + (x['process'] == "ttbbDL")*1. * ttbb_ttbb['ttbbDL'][ttbb_ttbb[ttbb_ttbb['Name'] == 'GenWeight_fsr_Def_down'].index]) * x.total_preweight))

                df = df.assign(total_weight_downfsr_ttbb=lambda x: ((((x['process'] == "ttSL") & (self.label == "ttlf"))*1. * ttlf['ttSL'][ttlf[ttlf['Name'] == 'GenWeight_fsr_Def_down'].index] + ((x['process'] == "ttDL") & (self.label == "ttlf"))*1. * ttlf['ttDL'][ttlf[ttlf['Name'] == 'GenWeight_fsr_Def_down'].index] + ((x['process'] == "ttSL") & (self.label == "ttcc"))*1. * ttcc['ttSL'][ttcc[ttcc['Name'] == 'GenWeight_fsr_Def_down'].index] + (
                    (x['process'] == "ttDL") & (self.label == "ttcc"))*1. * ttcc['ttDL'][ttcc[ttcc['Name'] == 'GenWeight_fsr_Def_down'].index] + (x['process'] == "ttbbSL")*1. * internal_ttbb['ttbbSL'][internal_ttbb[internal_ttbb['Name'] == 'GenWeight_fsr_Def_down'].index] * x['GenWeight_fsr_Def_down'] + (x['process'] == "ttbbDL")*1. * internal_ttbb['ttbbDL'][internal_ttbb[internal_ttbb['Name'] == 'GenWeight_fsr_Def_down'].index] * x['GenWeight_fsr_Def_down']) * x.total_preweight))

                df = df.assign(total_weight_downfsr_ttcc=lambda x: ((((x['process'] == "ttSL") & (self.label == "ttcc"))*1. * internal['ttSL'][internal[internal['Name'] == 'GenWeight_fsr_Def_down'].index] * x['GenWeight_fsr_Def_down'] + ((x['process'] == "ttDL") & (self.label == "ttcc"))*1. * internal['ttDL'][internal[internal['Name'] == 'GenWeight_fsr_Def_down'].index] * x['GenWeight_fsr_Def_down'] + (
                    (x['process'] == "ttSL") & (self.label == "ttlf"))*1. * ttlf['ttSL'][ttlf[ttlf['Name'] == 'GenWeight_fsr_Def_down'].index] + ((x['process'] == "ttDL") & (self.label == "ttlf"))*1. * ttlf['ttDL'][ttlf[ttlf['Name'] == 'GenWeight_fsr_Def_down'].index] + (x['process'] == "ttbbSL")*1. * internal_ttbb['ttbbSL'][internal_ttbb[internal_ttbb['Name'] == 'GenWeight_fsr_Def_down'].index] + (x['process'] == "ttbbDL")*1. * internal_ttbb['ttbbDL'][internal_ttbb[internal_ttbb['Name'] == 'GenWeight_fsr_Def_down'].index]) * x.total_preweight))
