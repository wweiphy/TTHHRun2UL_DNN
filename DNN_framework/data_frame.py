...
#                df = df.astype('float64') # added by Wei
        ...
        if Do_Evaluation:
            ...
            if "nominal" in self.path: 
                ...
                # df = df.assign(total_weight_scaleMuR_ttbbNLODown=lambda x: (((x['process'] == "ttbbSL")*1. * float(internal_ttbb['ttbbSL'][internal_ttbb[internal_ttbb['Name'] == 'Weight_scale_variation_muR_0p5_muF_1p0'].index]) * x['Weight_scale_variation_muR_0p5_muF_1p0'] + (x['process'] == "ttbbDL")*1. * float(internal_ttbb['ttbbDL'][internal_ttbb[internal_ttbb['Name'] == 'Weight_scale_variation_muR_0p5_muF_1p0'].index]) * x['Weight_scale_variation_muR_0p5_muF_1p0']) * x.total_preweight))
                ...
                df = df.assign(total_weight_scaleMuFDown=lambda x: (((x['process'] == "ttSL")*1. * float(internal['ttSL'][internal[internal['Name'] == 'Weight_scale_variation_muR_1p0_muF_0p5'].index]) * x['Weight_scale_variation_muR_1p0_muF_0p5'] + (x['process'] == "ttDL")*1. * float(internal['ttDL'][internal[internal['Name'] == 'Weight_scale_variation_muR_1p0_muF_0p5'].index]) *
                            x['Weight_scale_variation_muR_1p0_muF_0p5'] + (x['process'] == "ttbbSL")*1. * float(internal_ttbb['ttbbSL'][internal_ttbb[internal_ttbb['Name'] == 'Weight_scale_variation_muR_1p0_muF_0p5'].index]) + (x['process'] == "ttbbDL")*1. * float(internal_ttbb['ttbbSL'][internal_ttbb[internal_ttbb['Name'] == 'Weight_scale_variation_muR_1p0_muF_0p5'].index])) * x.total_preweight))

                # df = df.assign(total_weight_scaleMuF_ttbbNLODown=lambda x: (((x['process'] == "ttbbSL")*1. * float(internal_ttbb['ttbbSL'][internal_ttbb[internal_ttbb['Name'] == 'Weight_scale_variation_muR_1p0_muF_0p5'].index]) * x['Weight_scale_variation_muR_1p0_muF_0p5'] + (x['process'] == "ttbbDL")*1. * float(internal_ttbb['ttbbDL'][internal_ttbb[internal_ttbb['Name'] == 'Weight_scale_variation_muR_1p0_muF_0p5'].index]) * x['Weight_scale_variation_muR_1p0_muF_0p5']) * x.total_preweight))
                ...
                df = df.assign(total_weight_downisr_ttbb=lambda x: ((((x['process'] == "ttSL") & (self.label == "ttlf"))*1. * float(ttlf['ttSL'][ttlf[ttlf['Name'] == 'GenWeight_isr_Def_down'].index]) + ((x['process'] == "ttDL") & (self.label == "ttlf"))*1. * float(ttlf['ttDL'][ttlf[ttlf['Name'] == 'GenWeight_isr_Def_down'].index]) + ((x['process'] == "ttSL") & (self.label == "ttcc"))*1. * float(ttcc['ttSL'][ttcc[ttcc['Name'] == 'GenWeight_isr_Def_down'].index]) + ((x['process'] == "ttDL") & (self.label == "ttcc"))*1. * float(ttcc['ttDL'][ttcc[ttcc['Name'] == 'GenWeight_isr_Def_down'].index]) + (x['process'] == "ttbbSL")*1. * float(internal_ttbb['ttbbSL'][internal_ttbb[internal_ttbb['Name'] == 'GenWeight_isr_Def_down'].index]) * x['GenWeight_isr_Def_down'] + (x['process'] == "ttbbDL")*1. * float(internal_ttbb['ttbbDL'][internal_ttbb[internal_ttbb['Name'] == 'GenWeight_isr_Def_down'].index]) * x['GenWeight_isr_Def_down']) * x.total_preweight))
            ...
            if not (self.label == "SingleMuon" or self.label == "SingleElectron"):
                ...
                df = df.assign(total_preweight=lambda x: (x['lumiWeight'] * x['Weight_XS'] * x['Weight_CSV_UL'] * x['Weight_GEN_nom'] * x['Weight_pu69p2'] * x['Weight_JetPUID'] * (((x['N_TightElectrons'] == 1) & (x['Electron_IdentificationSFUp[0]'] > 0.) & (x['Electron_ReconstructionSFUp[0]'] > 0.))*1.*x['Electron_IdentificationSFUp[0]']*x['Electron_ReconstructionSFUp[0]'] + ((x['N_TightMuons'] == 1) & (x['Muon_IdentificationSF[0]'] > 0.) & (x['Muon_ReconstructionSF[0]'] > 0.) & (x['Muon_IsolationSF[0]'] > 0.))*1.*x['Muon_IdentificationSF[0]'] * x['Muon_IsolationSF[0]'] * x['Muon_ReconstructionSF[0]']) * ((((x['N_LooseMuons'] == 0) & (x['N_TightElectrons'] == 1)) & ((x['Triggered_HLT_Ele28_eta2p1_WPTight_Gsf_HT150_vX'] == 1) | (
                    (x['Triggered_HLT_Ele32_WPTight_Gsf_L1DoubleEG_vX'] == 1) & (x['Triggered_HLT_Ele32_WPTight_Gsf_2017SeedsX'] == 1))) & (x['Weight_ElectronTriggerSF'] > 0)) * 1. * x['Weight_ElectronTriggerSF'] + (((x['N_LooseElectrons'] == 0) & (x['N_TightMuons'] == 1) & (x['Triggered_HLT_IsoMu27_vX'])) & (x['Weight_MuonTriggerSF'] > 0.)) * 1. * x['Weight_MuonTriggerSF'])))
