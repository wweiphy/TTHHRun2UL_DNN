            ...
            for j, truth_cls in enumerate(self.event_classes):
                ...
                for syst in SystMap.systs:
                    ...
                    if truth_cls == "ttb" or truth_cls == "ttbb" or truth_cls == "tt2b" or truth_cls == "ttmb":
                        filtered_syst_weights = 61.0 * 2.0 * self.lumi * filtered_data[syst].values
                    else:
                ...
                if truth_cls == "ttb" or truth_cls == "ttbb" or truth_cls == "tt2b" or truth_cls == "ttmb":
                    ...
                    for x in range(320900, 321001):
                        weights_PDF = 61.0 * 2.0 * self.lumi * filtered_data["total_weight_PDF_Weight_{}".format(
                            x)].values
                    ...
                    for syst in SystMap.systs_ttbb:
                        ...
                        filtered_syst_weights = 61.0 * 2.0 * self.lumi * \
                            filtered_data[syst].values
