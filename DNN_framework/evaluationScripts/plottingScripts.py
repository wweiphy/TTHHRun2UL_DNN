...
class savenominalDiscriminators:
    ...
    def save(self):
        ...
        for i, node_cls in enumerate(self.event_classes):
            ...
            if node_cls == "ttZH":
                current_binrange = [0, 0.2, 0.23, 0.25, 0.28, 0.45]
            if node_cls == "ttZ":
                current_binrange = [0, 0.19, 0.21, 0.25, 0.28, 0.45]
            if node_cls == "ttZZ":
                current_binrange = [0, 0.18, 0.20, 0.23, 0.26, 0.27, 0.5]
            if node_cls == "ttlf":
                current_binrange = [0, 0.22, 0.3, 0.34, 0.4, 0.7]
            if node_cls == "ttcc":
                current_binrange = [0, 0.17, 0.2, 0.24, 0.27, 0.32, 0.5]
            if node_cls == "ttmb":
                current_binrange = [0, 0.18, 0.2, 0.23, 0.24, 0.28, 0.4]
            if node_cls == "ttnb":
                current_binrange = [0, 0.23, 0.26, 0.3, 0.33, 0.55]
...
class saveJESJERDiscriminators:
    ...
    def save(self):
        ...
        for i, node_cls in enumerate(self.event_classes):
            ...
            current_binrange = [0, 1]
            if node_cls == "ttHH":
                current_binrange = [0, 0.23, 0.27, 0.3, 0.33, 0.30, 0.55]
            if node_cls == "ttH":
