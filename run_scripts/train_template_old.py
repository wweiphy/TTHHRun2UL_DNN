...
# 4j3b 50
# python train_template_old.py -i DNN_1105_UL -o 221107_test_old  --plot --printroc -c ge4j_ge3t --epochs=500 --signalclass=ttHH -f 0.2 -v dnn_variables -n ge4j_ge3t_ttH 
