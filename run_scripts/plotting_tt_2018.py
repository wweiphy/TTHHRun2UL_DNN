...
# python plotting_tt.py -i Eval_0308_UL_nominal -o tt_2018 -c ge4j_ge3t -v variables -n ge4j_ge3t_ttH --epochs=500 --signalclass=ttHH -f 0.2 -v variables -n ge4j_ge3t_ttH --plot --printroc
...
# python plotting_tt.py -i Control_0409 -o tt_3 -c ge4j_2t -v variables -n ge4j_ge3t_ttH --epochs=500 --signalclass=ttHH -f 0.2 -v variables --plot --printroc
...
normalization_weight=2.333, train_weight=1, total_weight_expr=weight_expr)
input_samples.addSample(options.getDefaultName("ttccSL"),  label="ttcc",  normalization_weight=2.333, train_weight=1, total_weight_expr=weight_expr)
