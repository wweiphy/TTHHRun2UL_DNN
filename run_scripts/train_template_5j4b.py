...
# 4j3b 50
# python train_template.py -i DNN_0216_UL_2018 -o 230220_all  --plot --printroc -c ge5j_ge4t --epochs=500 --signalclass=ttHH -f 0.2 -v variables -n ge4j_ge3t_ttH

# python train_template.py -i DNN_0216_UL_2018 -o 230220_200  --plot --printroc -c ge5j_ge4t --epochs=500 --signalclass=ttHH -f 0.2 -v dnn_variables_new_200 -n ge4j_ge3t_ttH
