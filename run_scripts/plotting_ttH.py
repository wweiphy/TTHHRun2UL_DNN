...
# python plotting_ttH.py -i Control_0822_2017_data -o ttH_2017 -c ge4j_2t -v variables -n ge4j_ge3t_ttH --epochs=500 --signalclass=ttHH -f 0.2 -v variables --plot --printroc
