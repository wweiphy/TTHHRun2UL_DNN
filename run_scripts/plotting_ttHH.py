...
# python plotting_ttHH.py -i Eval_0308_UL_3_nominal -o ttHH_2018 -c ge5j_ge4t -v variables -n ge4j_ge3t_ttH --epochs=500 --signalclass=ttHH -f 0.2 -v variables -n ge4j_ge3t_ttH --plot --printroc --lumi=59.74 --year=2018 --ttHH=2.0


# python plotting_ttHH.py -i Eval_0523_UL_3_nominal -o ttHH_2016post -c ge4j_ge3t -v variables -n ge4j_ge3t_ttH --epochs=500 --signalclass=ttHH -f 0.2 -v variables -n ge4j_ge3t_ttH --plot --printroc
...
# python plotting_ttHH.py -i Control_0409_2 -o ttHH_2 -c ge4j_2t -v variables -n ge4j_ge3t_ttH --epochs=500 --signalclass=ttHH -f 0.2 -v variables --plot --printroc
...
# python plotting_ttHH.py -i Control_1718 -o ttHH_1718 -c ge4j_2t -v variables -n ge4j_ge3t_ttH --epochs=500 --signalclass=ttHH -f 0.2 -v variables --plot --printroc
...
input_samples.addSample(options.getDefaultName("ttHH"),  label = "ttHH",  normalization_weight = options.getNormttHH(), train_weight = 1, total_weight_expr = weight_expr)
