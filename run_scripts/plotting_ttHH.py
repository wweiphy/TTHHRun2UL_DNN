...
# input_samples.addSample(options.getDefaultName("ttHH_2017"),  label = "ttHH",  normalization_weight = 83., train_weight = 1, total_weight_expr = weight_expr)
# input_samples.addSample(options.getDefaultName("ttHH_2018"),  label = "ttHH",  normalization_weight =119.4, train_weight = 1, total_weight_expr = weight_expr)
