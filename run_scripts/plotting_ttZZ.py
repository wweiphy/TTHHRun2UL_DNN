...
# python plotting_ttZZ.py -i Eval_0308_UL_nominal -o ttZZ_2018 -c ge4j_ge3t -v variables -n ge4j_ge3t_ttH --epochs=500 --signalclass=ttHH -f 0.2 -v variables -n ge4j_ge3t_ttH --plot --printroc --lumi=59.74 --year=2018 --ttZZ=2.0
...
input_samples.addSample(options.getDefaultName("ttZZ"),  label = "ttZZ",  normalization_weight = options.getNormttZZ(), train_weight = 1, total_weight_expr = weight_expr)
