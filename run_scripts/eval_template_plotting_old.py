...
# python eval_template_plotting_old.py -o 230220_plotting_old -i 230220_50_old_ge4j_ge3t --signalclass=ttHH --plot --printroc -d Eval_0308_UL_nominal
...
dnn.plot_discriminators(log=options.log, signal_class=options.signal_class,lumi=59.8,
