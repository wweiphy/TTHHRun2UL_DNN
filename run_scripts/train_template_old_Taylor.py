...
# python train_template_old.py -i DNN_1130_UL -o 221130_100_old  --plot --printroc -c ge4j_ge3t --epochs=500 --signalclass=ttHH -f 0.2 -v dnn_variables_old_100 -n ge4j_ge3t_ttH -G True
