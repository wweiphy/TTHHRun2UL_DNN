...
"""
USE: python3 /uscms/home/wwei/nobackup/SM_TTHH/Summer20UL/EL8/CMSSW_12_4_3/src/TTHHRun2UL_DNN/preprocessing/template_UL_bTag_tt4b.py --outputdirectory=BTag_16pre_UL_nominal --variableselection=variables_bTagCorrection --maxentries=20000 --cores=4 --dataEra=2016preVFP
"""
...
dataset.addSample(
    sampleName="TT4b",
    ntuples=ntuplesPath2 +
    "/2016pre/ntuple/TT4b_TuneCP5_13TeV_madgraph_pythia8/sl_LEG_ntuple_2016preVFP/240630_041943/*/*nominal*.root",
    categories=ttnb_categories,
    process="tt4b",
    #    lumiWeight  = 41.5,
    selections=None,  # ttbar_selection,
