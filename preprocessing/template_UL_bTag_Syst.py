...
"""
USE: python3 /uscms/home/wwei/nobackup/SM_TTHH/Summer20UL/EL8/CMSSW_12_4_3/src/TTHHRun2UL_DNN/preprocessing/template_UL_bTag_Syst.py --outputdirectory=BTag_0119_UL --variableselection=variables_bTagCorrection --maxentries=20000 --cores=4  --syst=JERup --dataEra=2017
...
dataset.addSample(
    ...
    "/2017/ntuple/TTHHTo4b_TuneCP5_13TeV-madgraph-pythia8/sl_LEG_ntuple_2017/240626_010403/*/*" +
    options.syst+"*.root",
...
dataset.addSample(
    sampleName="TTZZ",
    ntuples=ntuplesPath2 +
    "/2017/ntuple/TTZZTo4b_TuneCP5_13TeV-madgraph-pythia8/sl_LEG_ntuple_2017/240627_013443/*/*" + options.syst+"*.root",
...
dataset.addSample(
    sampleName="TTZH",
    ntuples=ntuplesPath2 +
    "/2017/ntuple/TTZHTo4b_TuneCP5_13TeV-madgraph-pythia8/sl_LEG_ntuple_2017/240626_054315/*/*" + options.syst+"*.root",
    #    ntuples     = ntuplesPath+"/ttH_220208.root",
...
dataset.addSample(
    sampleName="TTZ",
    ntuples=ntuplesPath2 +
    "/2017/ntuple/TTZToBB_TuneCP5_13TeV-amcatnlo-pythia8/sl_LEG_ntuple_2017/240626_160152/*/*" + options.syst+"*.root",
...
dataset.addSample(
    sampleName  = "TTbbSL",
    ntuples=ntuplesPath2 +
    "/2017/ntuple/TTbb_4f_TTToSemiLeptonic_TuneCP5-Powheg-Openloops-Pythia8/sl_LEG_ntuple_2017/240627_154410/*/*"+options.syst+"*.root",
...
dataset.addSample(
    sampleName="TTbbDL",
    ntuples=ntuplesPath2 +
    "/2017/ntuple/TTbb_4f_TTTo2L2Nu_TuneCP5-Powheg-Openloops-Pythia8/sl_LEG_ntuple_2017/240627_032543/*/*"+options.syst+"*.root",
    # 221118_234955
...
dataset.addSample(
    sampleName="TT4b",
    ntuples=ntuplesPath2 +
    "/2017/ntuple/TT4b_TuneCP5_13TeV_madgraph_pythia8/sl_LEG_ntuple_2017/240626_010203/*/*" +
    options.syst+"*.root",
...
dataset.addSample(
    sampleName="TTHSL",
    ntuples=ntuplesPath2 +
    "/2017/ntuple/ttHTobb_ttToSemiLep_M125_TuneCP5_13TeV-powheg-pythia8/sl_LEG_ntuple_2017/240627_154742/*/*"+options.syst+"*.root",
    #    ntuples     = ntuplesPath+"/ttH_220208.root",
...
dataset.addSample(
    ...
    sampleName="TTHDL",
    ntuples=ntuplesPath2 +
    "/2017/ntuple/ttHTobb_ttTo2L2Nu_M125_TuneCP5_13TeV-powheg-pythia8/sl_LEG_ntuple_2017/240627_154602/*/*"+options.syst+"*.root",
    #    ntuples     = ntuplesPath+"/ttH_220208.root",
...
dataset.addSample(
    sampleName="TTSL",
    ntuples=ntuplesPath2 +
    "/2017/ntuple/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8/sl_LEG_ntuple_2017/240626_051938/*/*" + options.syst+"*.root",
...
dataset.addSample(
    sampleName="TTDL",
    ntuples=ntuplesPath2 +
    "/2017/ntuple/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8/sl_LEG_ntuple_2017/240626_015212/*/*" + options.syst+"*.root",
    #    ntuples     = ntuplesPath+"/ttSL_220210.root",
