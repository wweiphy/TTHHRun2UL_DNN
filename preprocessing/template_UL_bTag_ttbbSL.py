...
"""
USE: python3 /uscms/home/wwei/nobackup/SM_TTHH/Summer20UL/EL8/CMSSW_12_4_3/src/TTHHRun2UL_DNN/preprocessing/template_UL_bTag_ttbbSL.py --outputdirectory=BTag_16pre_UL_nominal --variableselection=variables_bTagCorrection --maxentries=20000 --cores=4 --dataEra=2016preVFP
"""
...
dataset.addSample(
    ...
    "/2016pre/ntuple/TTbb_4f_TTToSemiLeptonic_TuneCP5-Powheg-Openloops-Pythia8/sl_LEG_ntuple_2016preVFP/240703_215657/*/*nominal*.root",
...
#     sampleName  = "TTbbSL",
#     ntuples=ntuplesPath2 +
#     "/2016post/ntuple/TTbb_4f_TTToSemiLeptonic_TuneCP5-Powheg-Openloops-Pythia8/sl_LEG_ntuple_2016postVFP/240401_182131/*/*nominal*.root",
#     categories  = ttmb_categories,
#     process = "ttbbSL",
# #    lumiWeight  = 41.5,
#     selections=None,  # ttbar_selection,
