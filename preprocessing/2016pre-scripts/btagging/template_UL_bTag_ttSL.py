...
"""
USE: python3 /uscms/home/wwei/nobackup/SM_TTHH/Summer20UL/EL8/CMSSW_12_4_3/src/TTHHRun2UL_DNN/preprocessing/template_UL_bTag_ttSL.py --outputdirectory=BTag_16pre_UL_nominal --variableselection=variables_bTagCorrection --maxentries=20000 --cores=4 --dataEra=2016preVFP
"""
...
ttbar_categories.addCategory("ttSL", selection = "(GenEvt_I_TTPlusBB == 0 and GenEvt_I_TTPlusCC == 0) or (GenEvt_I_TTPlusBB == 0 and GenEvt_I_TTPlusCC == 1) or (GenEvt_I_TTPlusBB == 3 and GenEvt_I_TTPlusCC == 0) or (GenEvt_I_TTPlusBB == 2 and GenEvt_I_TTPlusCC == 0) or (GenEvt_I_TTPlusBB == 1 and GenEvt_I_TTPlusCC == 0)")
...
dataset.addSample(
    ...
    "/2016pre/ntuple/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8/sl_LEG_ntuple_2016preVFP/240701_045453/*/*nominal*.root",
...
#     sampleName="TTSL",
#     ntuples=ntuplesPath2 +
#     "/2016post/ntuple/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8/sl_LEG_ntuple_2016postVFP/240401_151754/*/*nominal*.root",
#     #    ntuples     = ntuplesPath+"/ttSL_220210.root",
#     categories=ttbar_categories,
#     process = "ttSL",
#     #    lumiWeight  = 41.5,
...
#     sampleName="TTDL",
#     ntuples=ntuplesPath2 +
#     "/2018/ntuple/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8/sl_LEG_ntuple_2018/240329_162107/*/*nominal*.root",
#     #    ntuples     = ntuplesPath+"/ttSL_220210.root",
#     categories=ttbar_categories,
#     process="ttDL",
#     # lumiWeight  = 1.0,
