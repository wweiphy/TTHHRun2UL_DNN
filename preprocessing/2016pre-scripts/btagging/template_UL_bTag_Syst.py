...
# 2016pre TTZ, TT4B
"""
USE: python3 /uscms/home/wwei/nobackup/SM_TTHH/Summer20UL/CMSSW_12_1_1/src/TTHHRun2UL_DNN/preprocessing/template_UL_bTag_Syst.py --outputdirectory=BTag_16pre_UL --variableselection=variables_bTagCorrection --maxentries=20000 --cores=8  --syst=JESup --dataEra=2016preVFP
...
dataset.addSample(
    ...
    "/2016pre/ntuple/TTHHTo4b_TuneCP5_13TeV-madgraph-pythia8/sl_LEG_ntuple_2016preVFP/240630_160547/*/*" +
    options.syst+"*.root",
...
dataset.addSample(
    sampleName="TTZZ",
    ntuples=ntuplesPath2 +
    "/2016pre/ntuple/TTZZTo4b_TuneCP5_13TeV-madgraph-pythia8/sl_LEG_ntuple_2016preVFP/240703_182222/*/*" + options.syst+"*.root",
...
dataset.addSample(
    sampleName="TTZH",
    ntuples=ntuplesPath2 +
    "/2016pre/ntuple/TTZHTo4b_TuneCP5_13TeV-madgraph-pythia8/sl_LEG_ntuple_2016preVFP/240702_041545/*/*" + options.syst+"*.root",
    #    ntuples     = ntuplesPath+"/ttH_220208.root",
...
dataset.addSample(
    sampleName="TTZ",
    ntuples=ntuplesPath2 +
    "/2016pre/ntuple/TTZToBB_TuneCP5_13TeV-amcatnlo-pythia8/sl_LEG_ntuple_2016preVFP/240703_162358/*/*" + options.syst+"*.root",
...
dataset.addSample(
    sampleName  = "TTbbSL",
    ntuples=ntuplesPath2 +
    "/2016pre/ntuple/TTbb_4f_TTToSemiLeptonic_TuneCP5-Powheg-Openloops-Pythia8/sl_LEG_ntuple_2016preVFP/240703_215657/*/*"+options.syst+"*.root",
...
dataset.addSample(
    sampleName="TTbbDL",
    ntuples=ntuplesPath2 +
    "/2016pre/ntuple/TTbb_4f_TTTo2L2Nu_TuneCP5-Powheg-Openloops-Pythia8/sl_LEG_ntuple_2016preVFP/240703_215454/*/*"+options.syst+"*.root",
    # 221118_234955
...
dataset.addSample(
    sampleName="TT4b",
    ntuples=ntuplesPath2 +
    "/2016pre/ntuple/TT4b_TuneCP5_13TeV_madgraph_pythia8/sl_LEG_ntuple_2016preVFP/240630_041943/*/*"+
    options.syst+"*.root",
...
dataset.addSample(
    sampleName="TTHSL",
    ntuples=ntuplesPath2 +
    "/2016pre/ntuple/ttHTobb_ttToSemiLep_M125_TuneCP5_13TeV-powheg-pythia8/sl_LEG_ntuple_2016preVFP/240704_040614/*/*"+options.syst+"*.root",
    #    ntuples     = ntuplesPath+"/ttH_220208.root",
...
dataset.addSample(
    ...
    sampleName="TTHDL",
    ntuples=ntuplesPath2 +
    "/2016pre/ntuple/ttHTobb_ttTo2L2Nu_M125_TuneCP5_13TeV-powheg-pythia8/sl_LEG_ntuple_2016preVFP/240703_215913/*/*"+options.syst+"*.root",
    #    ntuples     = ntuplesPath+"/ttH_220208.root",
...
dataset.addSample(
    sampleName="TTSL",
    ntuples=ntuplesPath2 +
    "/2016pre/ntuple/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8/sl_LEG_ntuple_2016preVFP/240701_045453/*/*" + options.syst+"*.root",
...
dataset.addSample(
    sampleName="TTDL",
    ntuples=ntuplesPath2 +
    "/2016pre/ntuple/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8/sl_LEG_ntuple_2016preVFP/240630_162354/*/*" + options.syst+"*.root",
    #    ntuples     = ntuplesPath+"/ttSL_220210.root",
