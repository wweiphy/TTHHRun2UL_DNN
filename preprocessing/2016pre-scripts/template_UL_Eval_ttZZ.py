...
"""
USE: python3 /uscms/home/wwei/nobackup/SM_TTHH/Summer20UL/EL8/CMSSW_12_4_3/src/TTHHRun2UL_DNN/preprocessing/template_UL_Eval_ttZZ.py --outputdirectory=Eval_0515_UL_4_nominal --variableselection=variables --maxentries=20000 --cores=4 --dataEra=2016preVFP
"""
...
dataset.addSample(
    ...
    "/2016pre/ntuple/TTZZTo4b_TuneCP5_13TeV-madgraph-pythia8/sl_LEG_ntuple_2016preVFP/230518_165745/*/*nominal*.root",
...
dataset.addSample(
    sampleName="TTZZ2",
    ntuples=ntuplesPath2 +
    "/2016pre/ntuple/TTZZTo4b_TuneCP5_13TeV-madgraph-pythia8/sl_LEG_ntuple_2016preVFP_Ext/230501_205804/*/*nominal*.root",
    #    ntuples     = ntuplesPath+"/ttH_220208.root",
    categories=ttZZ_categories,
    process = "ttZZ",
    #    lumiWeight  = 41.5,
