...
"""
USE: python3 /uscms/home/wwei/nobackup/SM_TTHH/Summer20UL/EL8/CMSSW_12_4_3/src/TTHHRun2UL_DNN/preprocessing/template_UL_Eval_Syst.py --outputdirectory=Eval_0515_UL_4 --variableselection=variables --maxentries=20000 --cores=4  --syst=JESup --dataEra=2016preVFP
...
dataset.addSample(
    sampleName="TT4b",
    ntuples=ntuplesPath2 +
    "/2016pre/ntuple/TT4b_TuneCP5_13TeV_madgraph_pythia8/sl_LEG_ntuple_2016preVFP/240407_043758/*/*" +
    options.syst+"*.root",
