...
"""
USE: python3 /uscms/home/wwei/nobackup/SM_TTHH/Summer20UL/EL8/CMSSW_12_4_3/src/TTHHRun2UL_DNN/preprocessing/template_UL_Eval_ttH.py --outputdirectory=Eval_0515_UL_4_nominal --variableselection=variables --maxentries=20000 --cores=4 --dataEra=2016preVFP
"""
...
dataset.addSample(
    sampleName="TTHDL",
    ntuples=ntuplesPath2 +
    "/2016pre/ntuple/ttHTobb_ttTo2L2Nu_M125_TuneCP5_13TeV-powheg-pythia8/sl_LEG_ntuple_2016preVFP/230502_021834/*/*nominal*.root",
    #    ntuples     = ntuplesPath+"/ttH_220208.root",
    categories=ttH_categories,
    process="ttHDL",
    #    lumiWeight  = 41.5,
