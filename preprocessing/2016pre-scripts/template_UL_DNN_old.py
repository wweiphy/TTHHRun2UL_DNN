...
"""
USE: python3 /uscms/home/wwei/nobackup/SM_TTHH/Summer20UL/CMSSW_12_1_1/src/TTHHRun2UL_DNN/preprocessing/2018-scripts/template_UL_DNN_old.py --outputdirectory=DNN_0211_old_2018 --variableselection=variables --maxentries=20000 --cores=6
"""
...
dataset.addSample(
    ...
    "/2016post/ntuple/TT4b_TuneCP5_13TeV_madgraph_pythia8/sl_LEG_ntuple_2016postVFP/230501_151230/*/*nominal*.root",
...
dataset.addSample(
    sampleName  = "TTbbSL",
    ntuples=ntuplesPath2 +
    "/2016post/ntuple/TTbb_4f_TTToSemiLeptonic_TuneCP5-Powheg-Openloops-Pythia8/sl_LEG_ntuple_2016postVFP/230501_194712/*/*nominal*.root",
