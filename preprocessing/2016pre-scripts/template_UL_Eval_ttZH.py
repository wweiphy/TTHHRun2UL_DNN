...
"""
USE: python3 /uscms/home/wwei/nobackup/SM_TTHH/Summer20UL/EL8/CMSSW_12_4_3/src/TTHHRun2UL_DNN/preprocessing/template_UL_Eval_ttZH.py --outputdirectory=Eval_0515_UL_4_nominal --variableselection=variables --maxentries=20000 --cores=4 --dataEra=2016preVFP
"""
...
dataset.addSample(
    ...
    "/2016pre/ntuple/TTZHTo4b_TuneCP5_13TeV-madgraph-pythia8/sl_LEG_ntuple_2016preVFP/230501_204359/*/*nominal*.root",
...
dataset.addSample(
    sampleName="TTZH2",
    ntuples=ntuplesPath2 +
    "/2016pre/ntuple/TTZHTo4b_TuneCP5_13TeV-madgraph-pythia8/sl_LEG_ntuple_2016preVFP_Ext/230501_204707/*/*nominal*.root",
    #    ntuples     = ntuplesPath+"/ttH_220208.root",
    categories=ttZH_categories,
    process = "ttZH",
    #    lumiWeight  = 41.5,
