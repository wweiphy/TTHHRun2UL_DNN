...
"""
USE: python3 /uscms/home/wwei/nobackup/SM_TTHH/Summer20UL/EL8/CMSSW_12_4_3/src/TTHHRun2UL_DNN/preprocessing/template_UL_bTag_ttbbDL.py --outputdirectory=BTag_16post_UL_nominal --variableselection=variables_bTagCorrection --maxentries=20000 --cores=4 --dataEra=2016postVFP
"""
...
#     "/2016pre/ntuple/TTbb_4f_TTTo2L2Nu_TuneCP5-Powheg-Openloops-Pythia8/sl_LEG_ntuple_2016preVFP/240403_010844/*/*nominal*.root",
#     # 221118_234955
...
dataset.addSample(
    sampleName="TTbbDL",
    ntuples=ntuplesPath2 +
    "/2016post/ntuple/TTbb_4f_TTTo2L2Nu_TuneCP5-Powheg-Openloops-Pythia8/sl_LEG_ntuple_2016postVFP/240629_044615/*/*nominal*.root",
    # 221118_234955
    categories=ttmb_categories,
    process="ttbbDL",
    #    lumiWeight  = 41.5,
