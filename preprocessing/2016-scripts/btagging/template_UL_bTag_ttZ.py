...
"""
USE: python3 /uscms/home/wwei/nobackup/SM_TTHH/Summer20UL/EL8/CMSSW_12_4_3/src/TTHHRun2UL_DNN/preprocessing/template_UL_bTag_ttZ.py --outputdirectory=BTag_16post_UL_nominal --variableselection=variables_bTagCorrection --maxentries=20000 --cores=4 --dataEra=2016postVFP
"""
...
#     "/2016pre/ntuple/TTZToBB_TuneCP5_13TeV-amcatnlo-pythia8/sl_LEG_ntuple_2016preVFP/240414_035125/*/*nominal*.root",
...
dataset.addSample(
    sampleName="TTZ",
    ntuples=ntuplesPath2 +
    "/2016post/ntuple/TTZToBB_TuneCP5_13TeV-amcatnlo-pythia8/sl_LEG_ntuple_2016postVFP/240629_043447/*/*nominal*.root",
    # ntuples="/uscms/home/wwei/nobackup/SM_TTHH/Summer20UL/CMSSW_10_6_29/src/BoostedTTH/BoostedAnalyzer/test/ntuples_nominal_Tree.root",
    #    ntuples     = ntuplesPath+"/ttH_220208.root",
    categories=ttZ_categories,
    process = "ttZ",
