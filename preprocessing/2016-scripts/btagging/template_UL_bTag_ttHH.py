...
"""
USE: python3 /uscms/home/wwei/nobackup/SM_TTHH/Summer20UL/EL8/CMSSW_12_4_3/src/TTHHRun2UL_DNN/preprocessing/template_UL_bTag_ttHH.py --outputdirectory=BTag_16post_UL_nominal --variableselection=variables_bTagCorrection --maxentries=20000 --cores=4 --dataEra=2016postVFP
"""
...
dataset.addSample(
    sampleName="TTHHTo4b",
    ntuples=ntuplesPath2 +
    "/2016post/ntuple/TTHHTo4b_TuneCP5_13TeV-madgraph-pythia8/sl_LEG_ntuple_2016postVFP/240628_220456/*/*nominal*.root",
    #    ntuples     = ntuplesPath+"/ttHH_4b.root",
    categories=ttHH_categories,
    process = "ttHH",
    #    lumiWeight  = 41.5,
