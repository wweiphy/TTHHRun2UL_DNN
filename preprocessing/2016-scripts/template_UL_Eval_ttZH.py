...
"""
USE: python3 /uscms/home/wwei/nobackup/SM_TTHH/Summer20UL/EL8/CMSSW_12_4_3/src/TTHHRun2UL_DNN/preprocessing/template_UL_Eval_ttZH.py --outputdirectory=Eval_0523_UL_4_nominal --variableselection=variables --maxentries=20000 --cores=4 --dataEra=2016postVFP
"""
...
dataset.addSample(
    ...
    "/2016post/ntuple/TTZHTo4b_TuneCP5_13TeV-madgraph-pythia8/sl_LEG_ntuple_2016postVFP/230510_170612/*/*nominal*.root",
...
dataset.addSample(
    sampleName="TTZH2",
    ntuples=ntuplesPath2 +
    "/2016post/ntuple/TTZHTo4b_TuneCP5_13TeV-madgraph-pythia8/sl_LEG_ntuple_2016postVFP_Ext/230501_193609/*/*nominal*.root",
    #    ntuples     = ntuplesPath+"/ttH_220208.root",
    categories=ttZH_categories,
    process = "ttZH",
    #    lumiWeight  = 41.5,
