...
"""
USE: python3 /uscms/home/wwei/nobackup/SM_TTHH/Summer20UL/EL8/CMSSW_12_4_3/src/TTHHRun2UL_DNN/preprocessing/template_UL_bTag_ttDL.py --outputdirectory=BTag_16pre_UL_nominal --variableselection=variables_bTagCorrection --maxentries=20000 --cores=4 --dataEra=2016preVFP
"""
...
ttbar_categories.addCategory("ttDL", selection = "(GenEvt_I_TTPlusBB == 0 and GenEvt_I_TTPlusCC == 0) or (GenEvt_I_TTPlusBB == 0 and GenEvt_I_TTPlusCC == 1) or (GenEvt_I_TTPlusBB == 3 and GenEvt_I_TTPlusCC == 0) or (GenEvt_I_TTPlusBB == 2 and GenEvt_I_TTPlusCC == 0) or (GenEvt_I_TTPlusBB == 1 and GenEvt_I_TTPlusCC == 0)")
...
dataset.addSample(
    sampleName="TTDL",
    ntuples=ntuplesPath2 +
    "/2016pre/ntuple/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8/sl_LEG_ntuple_2016preVFP/240630_162354/*/*nominal*.root",
    #    ntuples     = ntuplesPath+"/ttSL_220210.root",
    categories=ttbar_categories,
    process="ttDL",
    # lumiWeight  = 1.0,
...
#     sampleName="TTDL",
#     ntuples=ntuplesPath2 +
#     "/2016post/ntuple/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8/sl_LEG_ntuple_2016postVFP/240401_151406/*/*nominal*.root",
#     #    ntuples     = ntuplesPath+"/ttSL_220210.root",
#     categories=ttbar_categories,
#     process="ttDL",
#     # lumiWeight  = 1.0,
