...
"""
USE: python3 /uscms/home/wwei/nobackup/SM_TTHH/Summer20UL/EL8/CMSSW_12_4_3/src/TTHHRun2UL_DNN/preprocessing/template_UL_bTag_ttHSL.py --outputdirectory=BTag_16pre_UL_nominal --variableselection=variables_bTagCorrection --maxentries=20000 --cores=4 --dataEra=2016preVFP
"""
...
dataset.addSample(
    ...
    "/2016pre/ntuple/ttHTobb_ttToSemiLep_M125_TuneCP5_13TeV-powheg-pythia8/sl_LEG_ntuple_2016preVFP/240704_040614/*/*nominal*.root",
...
#     sampleName="TTHSL",
#     ntuples=ntuplesPath2 +
#     "/2016post/ntuple/ttHTobb_ttToSemiLep_M125_TuneCP5_13TeV-powheg-pythia8/sl_LEG_ntuple_2016postVFP/240401_200021/*/*nominal*.root",
#     #    ntuples     = ntuplesPath+"/ttH_220208.root",
#     categories=ttH_categories,
#     process = "ttHSL",
#     #    lumiWeight  = 41.5,
