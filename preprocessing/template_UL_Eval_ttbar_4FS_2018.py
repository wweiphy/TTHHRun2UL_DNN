...
"""
USE: python3 /uscms/home/wwei/nobackup/SM_TTHH/Summer20UL/CMSSW_12_1_1/src/TTHHRun2UL_DNN/preprocessing/template_UL_Eval_ttbar_4FS_2018.py --outputdirectory=Control_2018_4FS --variableselection=variables --maxentries=20000 --cores=8 --dataEra=2018
"""
...
dataset.addSample(
    ...
    "/2018/ntuple/TTbb_4f_TTToSemiLeptonic_TuneCP5-Powheg-Openloops-Pythia8/sl_LEG_ntuple_2018/230307_050749/*/*nominal*.root",
...
dataset.addSample(
    sampleName="TTbbDL",
    ntuples=ntuplesPath2 +
    "/2018/ntuple/TTbb_4f_TTTo2L2Nu_TuneCP5-Powheg-Openloops-Pythia8/sl_LEG_ntuple_2018/230307_044951/*/*nominal*.root",
    # 221118_234955
    categories=ttnb_categories,
    process="ttbbDL",
    #    lumiWeight  = 41.5,
