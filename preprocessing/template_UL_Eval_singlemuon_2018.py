...
"""
USE: python3 /uscms/home/wwei/nobackup/SM_TTHH/Summer20UL/EL8/CMSSW_12_4_3/src/TTHHRun2UL_DNN/preprocessing/template_UL_Eval_singlemuon_2018.py --outputdirectory=Eval_0308_UL_4_data --variableselection=variables --maxentries=20000 --cores=4 --dataEra=2018
"""
...
dataset.addSample(
    ...
    "/2018/ntuple/SingleMuon/sl_LEG_ntuple_2018/240726_192350/*/*nominal*.root",
...
dataset.addSample(
    ...
    ntuples=ntuplesPath2 +
    "/2018/ntuple/SingleMuon/sl_LEG_ntuple_2018/240730_185306/*/*nominal*.root",
...
dataset.addSample(
    ...
    ntuples=ntuplesPath2 +
    "/2018/ntuple/SingleMuon/sl_LEG_ntuple_2018/240731_181002/*/*nominal*.root",
