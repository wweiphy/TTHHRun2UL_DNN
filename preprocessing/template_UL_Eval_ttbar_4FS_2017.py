...
"""
USE: python3 /uscms/home/wwei/nobackup/SM_TTHH/Summer20UL/CMSSW_12_1_1/src/TTHHRun2UL_DNN/preprocessing/template_UL_Eval_ttbar_4FS_2017.py --outputdirectory=Control_2017_4FS --variableselection=variables --maxentries=20000 --cores=8 --dataEra=2017
"""
...
dataset.addSample(
    ...
    "/2017/ntuple/TTbb_4f_TTToSemiLeptonic_TuneCP5-Powheg-Openloops-Pythia8/sl_LEG_ntuple_2017/230723_225938/*/*nominal*.root",
...
dataset.addSample(
    sampleName="TTbbDL",
    ntuples=ntuplesPath2 +
    "/2017/ntuple/TTbb_4f_TTTo2L2Nu_TuneCP5-Powheg-Openloops-Pythia8/sl_LEG_ntuple_2017/230723_225402/*/*nominal*.root",
    # 221118_234955
    categories=ttnb_categories,
    process="ttbbDL",
    #    lumiWeight  = 41.5,
