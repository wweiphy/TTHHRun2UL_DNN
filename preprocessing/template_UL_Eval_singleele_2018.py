...
"""
USE: python3 /uscms/home/wwei/nobackup/SM_TTHH/Summer20UL/EL8/CMSSW_12_4_3/src/TTHHRun2UL_DNN/preprocessing/template_UL_Eval_singleele_2018.py --outputdirectory=Eval_0308_UL_4_data --variableselection=variables --maxentries=20000 --cores=4 --dataEra=2018
"""
...
dataset.addSample(
    ...
    "/2018/ntuple/EGamma/sl_LEG_ntuple_2018/240726_193711/*/*nominal*.root",
...
dataset.addSample(
    ...
    ntuples=ntuplesPath2 +
    "/2018/ntuple/EGamma/sl_LEG_ntuple_2018/240730_172528/*/*nominal*.root",
    #    ntuples     = ntuplesPath+"/ttH_220208.root",
    categories=eledata_categories,
    process = "data",
    #    lumiWeight  = 41.5,
...
dataset.addSample(
    ...
    ntuples=ntuplesPath2 +
    "/2018/ntuple/EGamma/sl_LEG_ntuple_2018/240731_175012/*/*nominal*.root",
    #    ntuples     = ntuplesPath+"/ttH_220208.root",
    categories=eledata_categories,
    process = "data",
    #    lumiWeight  = 41.5,
...
dataset.addSample(
    ...
    ntuples=ntuplesPath2 +
    "/2018/ntuple/EGamma/sl_LEG_ntuple_2018/240802_051340/*/*nominal*.root",
    #    ntuples     = ntuplesPath+"/ttH_220208.root",
    categories=eledata_categories,
    process = "data",
    #    lumiWeight  = 41.5,
