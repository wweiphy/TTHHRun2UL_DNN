...
"""
USE: python3 /uscms/home/wwei/nobackup/SM_TTHH/Summer20UL/CMSSW_12_1_1/src/TTHHRun2UL_DNN/preprocessing/template_UL_Eval_ttb_new.py --outputdirectory=Eval_1117_UL_ttb_new --variableselection=variables --maxentries=20000 --cores=4
"""
...
dataset.addSample(
    sampleName="TTbbToDL",
    ntuples=ntuplesPath2 +
    "/2017/ntuple/TTbb_4f_TTTo2L2Nu_TuneCP5-Powheg-Openloops-Pythia8/sl_LEG_ntuple_2017/221123_034145/*/*nominal*.root",
    # 221118_234955
    categories=ttmb_categories,
    #    lumiWeight  = 41.5,
    selections=None,  # ttbar_selection,
