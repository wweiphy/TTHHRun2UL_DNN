...
"""
USE: python3 /uscms/home/wwei/nobackup/SM_TTHH/Summer20UL/CMSSW_12_1_1/src/TTHHRun2UL_DNN/preprocessing/template_UL_Eval_ttH.py --outputdirectory=Control_0523 --variableselection=variables --maxentries=20000 --cores=8 --dataEra=2016postVFP
"""
...
dataset.addSample(
    sampleName="TTHSL",
    ntuples=ntuplesPath2 +
    "/2016post/ntuple/ttHTobb_ttToSemiLep_M125_TuneCP5_13TeV-powheg-pythia8/sl_LEG_ntuple_2016postVFP/231119_023943/*/*nominal*.root",
    #    ntuples     = ntuplesPath+"/ttH_220208.root",
    categories=ttH_categories,
    process = "ttH",
    #    lumiWeight  = 41.5,
...
dataset.addSample(
    sampleName="TTHDL",
    ntuples=ntuplesPath2 +
    "/2016post/ntuple/ttHTobb_ttTo2L2Nu_M125_TuneCP5_13TeV-powheg-pythia8/sl_LEG_ntuple_2016postVFP/231119_023753/*/*nominal*.root",
    #    ntuples     = ntuplesPath+"/ttH_220208.root",
    categories=ttH_categories,
    process="ttH",
    #    lumiWeight  = 41.5,
