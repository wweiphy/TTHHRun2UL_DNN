...
"""
USE: python3 /uscms/home/wwei/nobackup/SM_TTHH/Summer20UL/EL8/CMSSW_12_4_3/src/TTHHRun2UL_DNN/preprocessing/template_UL_Eval_ttZZ.py --outputdirectory=Eval_0308_UL_4_nominal --variableselection=variables --maxentries=20000 --cores=4 --dataEra=2018
"""
...
dataset.addSample(
    ...
    "/2018/ntuple/TTZZTo4b_TuneCP5_13TeV-madgraph-pythia8/sl_LEG_ntuple_2018/240318_192331/*/*nominal*.root",
...
dataset.addSample(
    sampleName="TTZZ2",
    ntuples=ntuplesPath2 +
    "/2018/ntuple/TTZZTo4b_TuneCP5_13TeV-madgraph-pythia8/sl_LEG_ntuple_2018_Ext/240318_192520/*/*nominal*.root",
    #    ntuples     = ntuplesPath+"/ttH_220208.root",
    categories=ttZZ_categories,
    process = "ttZZ",
    #    lumiWeight  = 41.5,
