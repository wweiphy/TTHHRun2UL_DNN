...
"""
USE: python3 /uscms/home/wwei/nobackup/SM_TTHH/Summer20UL/EL8/CMSSW_12_4_3/src/TTHHRun2UL_DNN/preprocessing/template_UL_bTag_ttHDL.py --outputdirectory=BTag_16post_UL_nominal --variableselection=variables_bTagCorrection --maxentries=20000 --cores=4 --dataEra=2016postVFP
"""
...
ttH_categories.addCategory("ttHDL", selection = None)
...
dataset.addSample(
    sampleName="TTHDL",
    ntuples=ntuplesPath2 +
    "/2016post/ntuple/ttHTobb_ttTo2L2Nu_M125_TuneCP5_13TeV-powheg-pythia8/sl_LEG_ntuple_2016postVFP/240629_145751/*/*nominal*.root",
    #    ntuples     = ntuplesPath+"/ttH_220208.root",
    categories=ttH_categories,
    process="ttHDL",
    #    lumiWeight  = 41.5,
