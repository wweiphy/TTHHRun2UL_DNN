...
plotOptions.add_option("--evaluation", dest="evaluation", default = True,
...
#        binFile = ROOT.TFile(binFileName)
        binFile = ROOT.TFile.Open(binFileName) # for eos file
...
#    print("inserting sys name '{}' into nominal template".format(options.systematicKey))
...
rootFile        = ROOT.TFile.Open(rootfilename, "readonly") # for eos file
...
for sample in samples:
    ...
    entry   = None
#    print ("sample plot " + str(samples[sample]['plot']))
#    print ("combineflag is " + str(combineflag))
...
print '''
# ========================================================
# Get errorband and signalhist in case of combine output file, else no signal
# ========================================================
'''
