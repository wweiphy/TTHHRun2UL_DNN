...
parser.add_option("-d", "--directory", dest="directory",
         help="PATH to datacard directory", metavar="/path/to/datacardMaker")
...
from datacardMaker2 import datacardMaker2
...
datacard=datacardMaker2(analysis,options.outputfile,hardcodenumbers=True,replacefiles=False)
