...
#    print("1 bin: {}".format(hist.GetBinContent(1)))
#    print("2 bin: {}".format(hist.GetBinContent(2)))
#    print("3 bin: {}".format(hist.GetBinContent(3)))
#    print("4 bin: {}".format(hist.GetBinContent(4)))
#    print("5 bin: {}".format(hist.GetBinContent(5)))
#    print("6 bin: {}".format(hist.GetBinContent(6)))
#    print("7 bin: {}".format(hist.GetBinContent(7)))
#    print("8 bin: {}".format(hist.GetBinContent(8)))
#    print("9 bin: {}".format(hist.GetBinContent(9)))
#    print("10 bin: {}".format(hist.GetBinContent(10)))
#    print("11 bin: {}".format(hist.GetBinContent(11)))
#    print("12 bin: {}".format(hist.GetBinContent(12)))
#    print("13 bin: {}".format(hist.GetBinContent(13)))
#    print("14 bin: {}".format(hist.GetBinContent(14)))
#    print("15 bin: {}".format(hist.GetBinContent(15)))
#    print("N bin: {}".format(hist.GetNbinsX()))
#    print("N+1 bin: {}".format(hist.GetNbinsX()+1))
#    print ("N+1 bin content: {}".format(hist.GetBinContent(hist.GetNbinsX()+1)))
    # move underflow
...
#        print("2 bin: {}".format(firstHist.GetBinContent(2)))
#        print("3 bin: {}".format(firstHist.GetBinContent(3)))
#        print("4 bin: {}".format(firstHist.GetBinContent(4)))
#        print("5 bin: {}".format(firstHist.GetBinContent(5)))
#        print("6 bin: {}".format(firstHist.GetBinContent(6)))
#        print("7 bin: {}".format(firstHist.GetBinContent(7)))
#        print("8 bin: {}".format(firstHist.GetBinContent(8)))
#        print("9 bin: {}".format(firstHist.GetBinContent(9)))
#        print("10 bin: {}".format(firstHist.GetBinContent(10)))
#        print("11 bin: {}".format(firstHist.GetBinContent(11)))
#        print("12 bin: {}".format(firstHist.GetBinContent(12)))
#        print("13 bin: {}".format(firstHist.GetBinContent(13)))
#        print("14 bin: {}".format(firstHist.GetBinContent(14)))
#        print("15 bin: {}".format(firstHist.GetBinContent(15)))
