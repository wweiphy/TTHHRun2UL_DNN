...
# python cardmakingscript.py -n old -f 230515_evaluation_old
# python cardmakingscript.py -n new -f 230515_evaluation_new
# python cardmakingscript.py -n new -f 230515_evaluation_new_5j4b
# python cardmakingscript.py -n new -f 230515_evaluation_new_6j4b

# python cardmakingscript.py -n old -f 230523_evaluation_old
# python cardmakingscript.py -n new -f 230523_evaluation_new
# python cardmakingscript.py -n new -f 230523_evaluation_new_5j4b
# python cardmakingscript.py -n new -f 230523_evaluation_new_6j4b
