...
samples = {  
    ...
    # 'ttZZ': {   'info': {   'color': 860L,
                            ...
                            # 'typ': 'bkg'},
                # 'plot': True},
    'ttbb_4FS': {   'info': {   'color': 634L,
                            'label': 't#bar{t}+b#bar{b} 4FS',
                            'typ': 'signal'},
                'plot': True},
    'ttbb_5FS': {   'info': {   'color': 860L,
...
plottingsamples = { 
   ...
   # 'ttH': {   'addSamples': [   'ttH'],
    ...
    #             'label': 't#bar{t}ZZ',
    #             'typ': 'bkg'},
    'ttbb 4FS': {   'addSamples': [   'ttbb_4FS'],
                'color': 634L,
                'label': 't#bar{t}bb 4FS',
                'typ': 'signal'},

    'ttbb 5FS': {   'addSamples': [   'ttbb_5FS'],
                'color': 860L,
                'label': 't#bar{t}bb 5FS',
                'typ': 'bkg'},
    # 'tt': {   'addSamples': [   'tt'],
    #             'color': 633L,
    #             'label': 't#bar{t}',
